...
/// see also \ref set_database_flag(), \ref clr_database_flag()
...
/// Set database flag
///      flags - DBFL_... bits
/// see also \ref save_database() (definition of the DBFL_... bits)
...
// tattr_enum Type attributes for enums
...
#define BTE_SIZE_MASK 0x07  // storage size.
#define BTE_OUT_MASK  0x60  // output style mask
#define BTE_HEX       0x00  // hex
#define BTE_CHAR      0x20  // char or hex
#define BTE_SDEC      0x40  // signed decimal
#define BTE_UDEC      0x60  // unsigned decimal
#define BTE_ALWAYS    0x80  // this bit MUST be present
#ifdef _notdefinedsymbol

/// \header Local types information and manipulation helpers
/// \id LocalTypeHelpers
...
#define get_ordinal_qty()                get_ordinal_limit()

...
NN_vpdpbusd = _ida_allins.NN_vpdpbusd

NN_vpdpbusds = _ida_allins.NN_vpdpbusds

NN_vpdpwssd = _ida_allins.NN_vpdpwssd

NN_vpdpwssds = _ida_allins.NN_vpdpwssds

NN_vpcompressb = _ida_allins.NN_vpcompressb

NN_vpcompressw = _ida_allins.NN_vpcompressw

NN_vpexpandb = _ida_allins.NN_vpexpandb

NN_vpexpandw = _ida_allins.NN_vpexpandw

NN_vpshldw = _ida_allins.NN_vpshldw

NN_vpshldd = _ida_allins.NN_vpshldd

NN_vpshldq = _ida_allins.NN_vpshldq

NN_vpshldvw = _ida_allins.NN_vpshldvw

NN_vpshldvd = _ida_allins.NN_vpshldvd

NN_vpshldvq = _ida_allins.NN_vpshldvq

NN_vpshrdw = _ida_allins.NN_vpshrdw

NN_vpshrdd = _ida_allins.NN_vpshrdd

NN_vpshrdq = _ida_allins.NN_vpshrdq

NN_vpshrdvw = _ida_allins.NN_vpshrdvw

NN_vpshrdvd = _ida_allins.NN_vpshrdvd

NN_vpshrdvq = _ida_allins.NN_vpshrdvq

NN_vpopcntb = _ida_allins.NN_vpopcntb

NN_vpopcntw = _ida_allins.NN_vpopcntw

NN_vpshufbitqmb = _ida_allins.NN_vpshufbitqmb

NN_vp2intersectd = _ida_allins.NN_vp2intersectd

NN_vp2intersectq = _ida_allins.NN_vp2intersectq

NN_vcvtne2ps2bf16 = _ida_allins.NN_vcvtne2ps2bf16

NN_vcvtneps2bf16 = _ida_allins.NN_vcvtneps2bf16

NN_vdpbf16ps = _ida_allins.NN_vdpbf16ps

NN_vaddph = _ida_allins.NN_vaddph

NN_vcmpph = _ida_allins.NN_vcmpph

NN_vcvtdq2ph = _ida_allins.NN_vcvtdq2ph

NN_vcvtpd2ph = _ida_allins.NN_vcvtpd2ph

NN_vcvtph2dq = _ida_allins.NN_vcvtph2dq

NN_vcvtph2pd = _ida_allins.NN_vcvtph2pd

NN_vcvtph2psx = _ida_allins.NN_vcvtph2psx

NN_vcvtph2qq = _ida_allins.NN_vcvtph2qq

NN_vcvtph2udq = _ida_allins.NN_vcvtph2udq

NN_vcvtph2uqq = _ida_allins.NN_vcvtph2uqq

NN_vcvtph2uw = _ida_allins.NN_vcvtph2uw

NN_vcvtph2w = _ida_allins.NN_vcvtph2w

NN_vcvtps2phx = _ida_allins.NN_vcvtps2phx

NN_vcvtqq2ph = _ida_allins.NN_vcvtqq2ph

NN_vcvttph2dq = _ida_allins.NN_vcvttph2dq

NN_vcvttph2qq = _ida_allins.NN_vcvttph2qq

NN_vcvttph2udq = _ida_allins.NN_vcvttph2udq

NN_vcvttph2uqq = _ida_allins.NN_vcvttph2uqq

NN_vcvttph2uw = _ida_allins.NN_vcvttph2uw

NN_vcvttph2w = _ida_allins.NN_vcvttph2w

NN_vcvtudq2ph = _ida_allins.NN_vcvtudq2ph

NN_vcvtuqq2ph = _ida_allins.NN_vcvtuqq2ph

NN_vcvtuw2ph = _ida_allins.NN_vcvtuw2ph

NN_vcvtw2ph = _ida_allins.NN_vcvtw2ph

NN_vdivph = _ida_allins.NN_vdivph

NN_vfcmaddcph = _ida_allins.NN_vfcmaddcph

NN_vfcmulcph = _ida_allins.NN_vfcmulcph

NN_vfmadd132ph = _ida_allins.NN_vfmadd132ph

NN_vfmadd213ph = _ida_allins.NN_vfmadd213ph

NN_vfmadd231ph = _ida_allins.NN_vfmadd231ph

NN_vfmaddcph = _ida_allins.NN_vfmaddcph

NN_vfmaddsub132ph = _ida_allins.NN_vfmaddsub132ph

NN_vfmaddsub213ph = _ida_allins.NN_vfmaddsub213ph

NN_vfmaddsub231ph = _ida_allins.NN_vfmaddsub231ph

NN_vfmsub132ph = _ida_allins.NN_vfmsub132ph

NN_vfmsub213ph = _ida_allins.NN_vfmsub213ph

NN_vfmsub231ph = _ida_allins.NN_vfmsub231ph

NN_vfmsubadd132ph = _ida_allins.NN_vfmsubadd132ph

NN_vfmsubadd213ph = _ida_allins.NN_vfmsubadd213ph

NN_vfmsubadd231ph = _ida_allins.NN_vfmsubadd231ph

NN_vfmulcph = _ida_allins.NN_vfmulcph

NN_vfnmadd132ph = _ida_allins.NN_vfnmadd132ph

NN_vfnmadd213ph = _ida_allins.NN_vfnmadd213ph

NN_vfnmadd231ph = _ida_allins.NN_vfnmadd231ph

NN_vfnmsub132ph = _ida_allins.NN_vfnmsub132ph

NN_vfnmsub213ph = _ida_allins.NN_vfnmsub213ph

NN_vfnmsub231ph = _ida_allins.NN_vfnmsub231ph

NN_vfpclassph = _ida_allins.NN_vfpclassph

NN_vgetexpph = _ida_allins.NN_vgetexpph

NN_vgetmantph = _ida_allins.NN_vgetmantph

NN_vmaxph = _ida_allins.NN_vmaxph

NN_vminph = _ida_allins.NN_vminph

NN_vmulph = _ida_allins.NN_vmulph

NN_vrcpph = _ida_allins.NN_vrcpph

NN_vreduceph = _ida_allins.NN_vreduceph

NN_vrndscaleph = _ida_allins.NN_vrndscaleph

NN_vrsqrtph = _ida_allins.NN_vrsqrtph

NN_vscalefph = _ida_allins.NN_vscalefph

NN_vsqrtph = _ida_allins.NN_vsqrtph

NN_vsubph = _ida_allins.NN_vsubph

NN_vmovw = _ida_allins.NN_vmovw

NN_vaddsh = _ida_allins.NN_vaddsh

NN_vcmpsh = _ida_allins.NN_vcmpsh

NN_vcomish = _ida_allins.NN_vcomish

NN_vcvtsd2sh = _ida_allins.NN_vcvtsd2sh

NN_vcvtsh2sd = _ida_allins.NN_vcvtsh2sd

NN_vcvtsh2si = _ida_allins.NN_vcvtsh2si

NN_vcvtsh2ss = _ida_allins.NN_vcvtsh2ss

NN_vcvtsh2usi = _ida_allins.NN_vcvtsh2usi

NN_vcvtsi2sh = _ida_allins.NN_vcvtsi2sh

NN_vcvtss2sh = _ida_allins.NN_vcvtss2sh

NN_vcvttsh2si = _ida_allins.NN_vcvttsh2si

NN_vcvttsh2usi = _ida_allins.NN_vcvttsh2usi

NN_vcvtusi2sh = _ida_allins.NN_vcvtusi2sh

NN_vdivsh = _ida_allins.NN_vdivsh

NN_vfcmaddcsh = _ida_allins.NN_vfcmaddcsh

NN_vfcmulcsh = _ida_allins.NN_vfcmulcsh

NN_vfmadd132sh = _ida_allins.NN_vfmadd132sh

NN_vfmadd213sh = _ida_allins.NN_vfmadd213sh

NN_vfmadd231sh = _ida_allins.NN_vfmadd231sh

NN_vfmaddcsh = _ida_allins.NN_vfmaddcsh

NN_vfmsub132sh = _ida_allins.NN_vfmsub132sh

NN_vfmsub213sh = _ida_allins.NN_vfmsub213sh

NN_vfmsub231sh = _ida_allins.NN_vfmsub231sh

NN_vfmulcsh = _ida_allins.NN_vfmulcsh

NN_vfnmadd132sh = _ida_allins.NN_vfnmadd132sh

NN_vfnmadd213sh = _ida_allins.NN_vfnmadd213sh

NN_vfnmadd231sh = _ida_allins.NN_vfnmadd231sh

NN_vfnmsub132sh = _ida_allins.NN_vfnmsub132sh

NN_vfnmsub213sh = _ida_allins.NN_vfnmsub213sh

NN_vfnmsub231sh = _ida_allins.NN_vfnmsub231sh

NN_vfpclasssh = _ida_allins.NN_vfpclasssh

NN_vgetexpsh = _ida_allins.NN_vgetexpsh

NN_vgetmantsh = _ida_allins.NN_vgetmantsh

NN_vmaxsh = _ida_allins.NN_vmaxsh

NN_vminsh = _ida_allins.NN_vminsh

NN_vmovsh = _ida_allins.NN_vmovsh

NN_vmulsh = _ida_allins.NN_vmulsh

NN_vrcpsh = _ida_allins.NN_vrcpsh

NN_vreducesh = _ida_allins.NN_vreducesh

NN_vrndscalesh = _ida_allins.NN_vrndscalesh

NN_vrsqrtsh = _ida_allins.NN_vrsqrtsh

NN_vscalefsh = _ida_allins.NN_vscalefsh

NN_vsqrtsh = _ida_allins.NN_vsqrtsh

NN_vsubsh = _ida_allins.NN_vsubsh

NN_vucomish = _ida_allins.NN_vucomish

NN_clui = _ida_allins.NN_clui

NN_stui = _ida_allins.NN_stui

NN_testui = _ida_allins.NN_testui

NN_uiret = _ida_allins.NN_uiret

NN_senduipi = _ida_allins.NN_senduipi

NN_hreset = _ida_allins.NN_hreset
...
ARM_bcax = _ida_allins.ARM_bcax

ARM_eor3 = _ida_allins.ARM_eor3

ARM_rax1 = _ida_allins.ARM_rax1

ARM_xar = _ida_allins.ARM_xar

ARM_sha512h = _ida_allins.ARM_sha512h

ARM_sha512h2 = _ida_allins.ARM_sha512h2

ARM_sha512su0 = _ida_allins.ARM_sha512su0

ARM_sha512su1 = _ida_allins.ARM_sha512su1

ARM_sm3partw1 = _ida_allins.ARM_sm3partw1

ARM_sm3partw2 = _ida_allins.ARM_sm3partw2

ARM_sm3ss1 = _ida_allins.ARM_sm3ss1

ARM_sm3tt1a = _ida_allins.ARM_sm3tt1a

ARM_sm3tt1b = _ida_allins.ARM_sm3tt1b

ARM_sm3tt2a = _ida_allins.ARM_sm3tt2a

ARM_sm3tt2b = _ida_allins.ARM_sm3tt2b

ARM_sm4e = _ida_allins.ARM_sm4e

ARM_sm4ekey = _ida_allins.ARM_sm4ekey

ARM_sudot = _ida_allins.ARM_sudot

ARM_ummla = _ida_allins.ARM_ummla

ARM_usdot = _ida_allins.ARM_usdot

ARM_usmmla = _ida_allins.ARM_usmmla

ARM_sdot = _ida_allins.ARM_sdot

ARM_udot = _ida_allins.ARM_udot

ARM_fmlal = _ida_allins.ARM_fmlal

ARM_fmlal2 = _ida_allins.ARM_fmlal2

ARM_fmlsl = _ida_allins.ARM_fmlsl

ARM_fmlsl2 = _ida_allins.ARM_fmlsl2

ARM_bfmmla = _ida_allins.ARM_bfmmla

ARM_bfmlalb = _ida_allins.ARM_bfmlalb

ARM_bfmlalt = _ida_allins.ARM_bfmlalt

ARM_bfdot = _ida_allins.ARM_bfdot

ARM_bfcvtn = _ida_allins.ARM_bfcvtn

ARM_bfcvtn2 = _ida_allins.ARM_bfcvtn2

ARM_bfcvt = _ida_allins.ARM_bfcvt

ARM_trap = _ida_allins.ARM_trap

ARM_trap2 = _ida_allins.ARM_trap2

ARM_genter = _ida_allins.ARM_genter

ARM_gexit = _ida_allins.ARM_gexit

ARM_wkdmc = _ida_allins.ARM_wkdmc

ARM_wkdmd = _ida_allins.ARM_wkdmd

ARM_sdsb = _ida_allins.ARM_sdsb

ARM_amx = _ida_allins.ARM_amx

ARM_mul53lo = _ida_allins.ARM_mul53lo

ARM_mul53hi = _ida_allins.ARM_mul53hi
...
MIPS_mfthc0 = _ida_allins.MIPS_mfthc0
...
MIPS_mtthc0 = _ida_allins.MIPS_mtthc0
...
MIPS_muh = _ida_allins.MIPS_muh

MIPS_mulu = _ida_allins.MIPS_mulu

MIPS_muhu = _ida_allins.MIPS_muhu

MIPS_mod = _ida_allins.MIPS_mod

MIPS_modu = _ida_allins.MIPS_modu

MIPS_sov = _ida_allins.MIPS_sov

MIPS_crc32b = _ida_allins.MIPS_crc32b

MIPS_crc32h = _ida_allins.MIPS_crc32h

MIPS_crc32w = _ida_allins.MIPS_crc32w

MIPS_crc32cb = _ida_allins.MIPS_crc32cb

MIPS_crc32ch = _ida_allins.MIPS_crc32ch

MIPS_crc32cw = _ida_allins.MIPS_crc32cw

MIPS_sbx = _ida_allins.MIPS_sbx

MIPS_shx = _ida_allins.MIPS_shx

MIPS_shxs = _ida_allins.MIPS_shxs

MIPS_swx = _ida_allins.MIPS_swx

MIPS_swxs = _ida_allins.MIPS_swxs

MIPS_lhxs = _ida_allins.MIPS_lhxs

MIPS_lhuxs = _ida_allins.MIPS_lhuxs

MIPS_mfhc0 = _ida_allins.MIPS_mfhc0

MIPS_mthc0 = _ida_allins.MIPS_mthc0

MIPS_extw = _ida_allins.MIPS_extw

MIPS_tlbinv = _ida_allins.MIPS_tlbinv

MIPS_tlbinvf = _ida_allins.MIPS_tlbinvf

MIPS_ginvt = _ida_allins.MIPS_ginvt

MIPS_ginvi = _ida_allins.MIPS_ginvi

MIPS_eretnc = _ida_allins.MIPS_eretnc

MIPS_lwpc = _ida_allins.MIPS_lwpc

MIPS_swpc = _ida_allins.MIPS_swpc

MIPS_rotx = _ida_allins.MIPS_rotx

MIPS_llwp = _ida_allins.MIPS_llwp

MIPS_llwpe = _ida_allins.MIPS_llwpe

MIPS_scwp = _ida_allins.MIPS_scwp

MIPS_scwpe = _ida_allins.MIPS_scwpe

MIPS_ualwm = _ida_allins.MIPS_ualwm

MIPS_uaswm = _ida_allins.MIPS_uaswm

MIPS_ualh = _ida_allins.MIPS_ualh

MIPS_uash = _ida_allins.MIPS_uash

MIPS_syncie = _ida_allins.MIPS_syncie

MIPS_dvp = _ida_allins.MIPS_dvp

MIPS_evp = _ida_allins.MIPS_evp

MIPS_sigrie = _ida_allins.MIPS_sigrie

MIPS_bc = _ida_allins.MIPS_bc

MIPS_balc = _ida_allins.MIPS_balc

MIPS_restore_jrc = _ida_allins.MIPS_restore_jrc

MIPS_move_balc = _ida_allins.MIPS_move_balc

MIPS_addiupc = _ida_allins.MIPS_addiupc

MIPS_jalrc_hb = _ida_allins.MIPS_jalrc_hb

MIPS_aluipc = _ida_allins.MIPS_aluipc

MIPS_beqic = _ida_allins.MIPS_beqic

MIPS_bbeqzc = _ida_allins.MIPS_bbeqzc

MIPS_bgeic = _ida_allins.MIPS_bgeic

MIPS_bgeiuc = _ida_allins.MIPS_bgeiuc

MIPS_bneic = _ida_allins.MIPS_bneic

MIPS_bbnezc = _ida_allins.MIPS_bbnezc

MIPS_bltic = _ida_allins.MIPS_bltic

MIPS_bltiuc = _ida_allins.MIPS_bltiuc

MIPS_bnec = _ida_allins.MIPS_bnec

MIPS_bltc = _ida_allins.MIPS_bltc

MIPS_bltuc = _ida_allins.MIPS_bltuc

MIPS_beqc = _ida_allins.MIPS_beqc

MIPS_bgec = _ida_allins.MIPS_bgec

MIPS_bgeuc = _ida_allins.MIPS_bgeuc

MIPS_brsc = _ida_allins.MIPS_brsc

MIPS_balrsc = _ida_allins.MIPS_balrsc

MIPS_bitrevw = _ida_allins.MIPS_bitrevw

MIPS_bitrevh = _ida_allins.MIPS_bitrevh

MIPS_bitrevb = _ida_allins.MIPS_bitrevb

MIPS_byterevw = _ida_allins.MIPS_byterevw

MIPS_byterevh = _ida_allins.MIPS_byterevh
...
PPC_zbrminc = _ida_allins.PPC_zbrminc

PPC_zcircinc = _ida_allins.PPC_zcircinc

PPC_zvabsh = _ida_allins.PPC_zvabsh

PPC_zvabshs = _ida_allins.PPC_zvabshs

PPC_zabsw = _ida_allins.PPC_zabsw

PPC_zabsws = _ida_allins.PPC_zabsws

PPC_zaddd = _ida_allins.PPC_zaddd

PPC_zadddss = _ida_allins.PPC_zadddss

PPC_zadddus = _ida_allins.PPC_zadddus

PPC_zvaddh = _ida_allins.PPC_zvaddh

PPC_zvaddhss = _ida_allins.PPC_zvaddhss

PPC_zvaddhus = _ida_allins.PPC_zvaddhus

PPC_zvaddhx = _ida_allins.PPC_zvaddhx

PPC_zvaddhxss = _ida_allins.PPC_zvaddhxss

PPC_zvaddih = _ida_allins.PPC_zvaddih

PPC_zvaddsubfh = _ida_allins.PPC_zvaddsubfh

PPC_zvaddsubfhss = _ida_allins.PPC_zvaddsubfhss

PPC_zvaddsubfhx = _ida_allins.PPC_zvaddsubfhx

PPC_zvaddsubfhxss = _ida_allins.PPC_zvaddsubfhxss

PPC_zaddhesw = _ida_allins.PPC_zaddhesw

PPC_zaddheuw = _ida_allins.PPC_zaddheuw

PPC_zaddhosw = _ida_allins.PPC_zaddhosw

PPC_zaddhouw = _ida_allins.PPC_zaddhouw

PPC_zvaddw = _ida_allins.PPC_zvaddw

PPC_zvaddsubfw = _ida_allins.PPC_zvaddsubfw

PPC_zvaddsubfwss = _ida_allins.PPC_zvaddsubfwss

PPC_zaddwgsf = _ida_allins.PPC_zaddwgsf

PPC_zaddwgsi = _ida_allins.PPC_zaddwgsi

PPC_zaddwgui = _ida_allins.PPC_zaddwgui

PPC_zaddwss = _ida_allins.PPC_zaddwss

PPC_zvaddwss = _ida_allins.PPC_zvaddwss

PPC_zaddwus = _ida_allins.PPC_zaddwus

PPC_zvaddwus = _ida_allins.PPC_zvaddwus

PPC_zvcmpeqh = _ida_allins.PPC_zvcmpeqh

PPC_zvcmpgths = _ida_allins.PPC_zvcmpgths

PPC_zvcmpgthu = _ida_allins.PPC_zvcmpgthu

PPC_zvcmplths = _ida_allins.PPC_zvcmplths

PPC_zvcmplthu = _ida_allins.PPC_zvcmplthu

PPC_zvcntlsh = _ida_allins.PPC_zvcntlsh

PPC_zcntlsw = _ida_allins.PPC_zcntlsw

PPC_zvcntlzh = _ida_allins.PPC_zvcntlzh

PPC_zdivwsf = _ida_allins.PPC_zdivwsf

PPC_zvmergehih = _ida_allins.PPC_zvmergehih

PPC_zvmergehiloh = _ida_allins.PPC_zvmergehiloh

PPC_zvmergeloh = _ida_allins.PPC_zvmergeloh

PPC_zvmergelohih = _ida_allins.PPC_zvmergelohih

PPC_zvnegh = _ida_allins.PPC_zvnegh

PPC_zvnegho = _ida_allins.PPC_zvnegho

PPC_zvneghos = _ida_allins.PPC_zvneghos

PPC_zvneghs = _ida_allins.PPC_zvneghs

PPC_znegws = _ida_allins.PPC_znegws

PPC_zvpkshgwshfrs = _ida_allins.PPC_zvpkshgwshfrs

PPC_zpkswgshfrs = _ida_allins.PPC_zpkswgshfrs

PPC_zpkswgswfrs = _ida_allins.PPC_zpkswgswfrs

PPC_zvpkswshfrs = _ida_allins.PPC_zvpkswshfrs

PPC_zvpkswshs = _ida_allins.PPC_zvpkswshs

PPC_zvpkswuhs = _ida_allins.PPC_zvpkswuhs

PPC_zvpkuwuhs = _ida_allins.PPC_zvpkuwuhs

PPC_zvrlh = _ida_allins.PPC_zvrlh

PPC_zvrlhi = _ida_allins.PPC_zvrlhi

PPC_zrndwh = _ida_allins.PPC_zrndwh

PPC_zrndwhss = _ida_allins.PPC_zrndwhss

PPC_zsatsdsw = _ida_allins.PPC_zsatsdsw

PPC_zsatsduw = _ida_allins.PPC_zsatsduw

PPC_zvsatshuh = _ida_allins.PPC_zvsatshuh

PPC_zsatswsh = _ida_allins.PPC_zsatswsh

PPC_zsatswuh = _ida_allins.PPC_zsatswuh

PPC_zsatswuw = _ida_allins.PPC_zsatswuw

PPC_zsatuduw = _ida_allins.PPC_zsatuduw

PPC_zvsatuhsh = _ida_allins.PPC_zvsatuhsh

PPC_zsatuwsw = _ida_allins.PPC_zsatuwsw

PPC_zsatuwsh = _ida_allins.PPC_zsatuwsh

PPC_zsatuwuh = _ida_allins.PPC_zsatuwuh

PPC_zvselh = _ida_allins.PPC_zvselh

PPC_zvslh = _ida_allins.PPC_zvslh

PPC_zvslhi = _ida_allins.PPC_zvslhi

PPC_zvslhss = _ida_allins.PPC_zvslhss

PPC_zvslhiss = _ida_allins.PPC_zvslhiss

PPC_zvslhus = _ida_allins.PPC_zvslhus

PPC_zvslhius = _ida_allins.PPC_zvslhius

PPC_zslwss = _ida_allins.PPC_zslwss

PPC_zslwiss = _ida_allins.PPC_zslwiss

PPC_zslwus = _ida_allins.PPC_zslwus

PPC_zslwius = _ida_allins.PPC_zslwius

PPC_zvsplatfih = _ida_allins.PPC_zvsplatfih

PPC_zvsplatih = _ida_allins.PPC_zvsplatih

PPC_zvsrhis = _ida_allins.PPC_zvsrhis

PPC_zvsrhiu = _ida_allins.PPC_zvsrhiu

PPC_zvsrhs = _ida_allins.PPC_zvsrhs

PPC_zvsrhu = _ida_allins.PPC_zvsrhu

PPC_zvsubfaddh = _ida_allins.PPC_zvsubfaddh

PPC_zvsubfaddhss = _ida_allins.PPC_zvsubfaddhss

PPC_zvsubfaddhx = _ida_allins.PPC_zvsubfaddhx

PPC_zvsubfaddhxss = _ida_allins.PPC_zvsubfaddhxss

PPC_zsubfd = _ida_allins.PPC_zsubfd

PPC_zsubfdss = _ida_allins.PPC_zsubfdss

PPC_zsubfdus = _ida_allins.PPC_zsubfdus

PPC_zvsubfh = _ida_allins.PPC_zvsubfh

PPC_zsubfhesw = _ida_allins.PPC_zsubfhesw

PPC_zsubfheuw = _ida_allins.PPC_zsubfheuw

PPC_zsubfhosw = _ida_allins.PPC_zsubfhosw

PPC_zsubfhouw = _ida_allins.PPC_zsubfhouw

PPC_zvsubfhss = _ida_allins.PPC_zvsubfhss

PPC_zvsubfhus = _ida_allins.PPC_zvsubfhus

PPC_zvsubfhx = _ida_allins.PPC_zvsubfhx

PPC_zvsubfhxss = _ida_allins.PPC_zvsubfhxss

PPC_zvsubfw = _ida_allins.PPC_zvsubfw

PPC_zvsubfaddw = _ida_allins.PPC_zvsubfaddw

PPC_zvsubfaddwss = _ida_allins.PPC_zvsubfaddwss

PPC_zsubfwgsf = _ida_allins.PPC_zsubfwgsf

PPC_zsubfwgsi = _ida_allins.PPC_zsubfwgsi

PPC_zsubfwgui = _ida_allins.PPC_zsubfwgui

PPC_zsubfwss = _ida_allins.PPC_zsubfwss

PPC_zvsubfwss = _ida_allins.PPC_zvsubfwss

PPC_zsubfwus = _ida_allins.PPC_zsubfwus

PPC_zvsubfwus = _ida_allins.PPC_zvsubfwus

PPC_zvsubifh = _ida_allins.PPC_zvsubifh

PPC_zvunpkhgwsf = _ida_allins.PPC_zvunpkhgwsf

PPC_zvunpkhsf = _ida_allins.PPC_zvunpkhsf

PPC_zvunpkhsi = _ida_allins.PPC_zvunpkhsi

PPC_zvunpkhui = _ida_allins.PPC_zvunpkhui

PPC_zunpkwgsf = _ida_allins.PPC_zunpkwgsf

PPC_zxtrw = _ida_allins.PPC_zxtrw

PPC_zldd = _ida_allins.PPC_zldd

PPC_zlddu = _ida_allins.PPC_zlddu

PPC_zlddx = _ida_allins.PPC_zlddx

PPC_zlddmx = _ida_allins.PPC_zlddmx

PPC_zldh = _ida_allins.PPC_zldh

PPC_zldhu = _ida_allins.PPC_zldhu

PPC_zldhx = _ida_allins.PPC_zldhx

PPC_zldhmx = _ida_allins.PPC_zldhmx

PPC_zldw = _ida_allins.PPC_zldw

PPC_zldwu = _ida_allins.PPC_zldwu

PPC_zldwx = _ida_allins.PPC_zldwx

PPC_zldwmx = _ida_allins.PPC_zldwmx

PPC_zlhgwsf = _ida_allins.PPC_zlhgwsf

PPC_zlhgwsfu = _ida_allins.PPC_zlhgwsfu

PPC_zlhgwsfx = _ida_allins.PPC_zlhgwsfx

PPC_zlhgwsfmx = _ida_allins.PPC_zlhgwsfmx

PPC_zlhhe = _ida_allins.PPC_zlhhe

PPC_zlhheu = _ida_allins.PPC_zlhheu

PPC_zlhhex = _ida_allins.PPC_zlhhex

PPC_zlhhemx = _ida_allins.PPC_zlhhemx

PPC_zlhhos = _ida_allins.PPC_zlhhos

PPC_zlhhosu = _ida_allins.PPC_zlhhosu

PPC_zlhhosx = _ida_allins.PPC_zlhhosx

PPC_zlhhosmx = _ida_allins.PPC_zlhhosmx

PPC_zlhhou = _ida_allins.PPC_zlhhou

PPC_zlhhouu = _ida_allins.PPC_zlhhouu

PPC_zlhhoux = _ida_allins.PPC_zlhhoux

PPC_zlhhoumx = _ida_allins.PPC_zlhhoumx

PPC_zlhhsplat = _ida_allins.PPC_zlhhsplat

PPC_zlhhsplatu = _ida_allins.PPC_zlhhsplatu

PPC_zlhhsplatx = _ida_allins.PPC_zlhhsplatx

PPC_zlhhsplatmx = _ida_allins.PPC_zlhhsplatmx

PPC_zlwgsfd = _ida_allins.PPC_zlwgsfd

PPC_zlwgsfdu = _ida_allins.PPC_zlwgsfdu

PPC_zlwgsfdx = _ida_allins.PPC_zlwgsfdx

PPC_zlwgsfdmx = _ida_allins.PPC_zlwgsfdmx

PPC_zlwh = _ida_allins.PPC_zlwh

PPC_zlwhu = _ida_allins.PPC_zlwhu

PPC_zlwhx = _ida_allins.PPC_zlwhx

PPC_zlwhmx = _ida_allins.PPC_zlwhmx

PPC_zlwhed = _ida_allins.PPC_zlwhed

PPC_zlwhedu = _ida_allins.PPC_zlwhedu

PPC_zlwhedx = _ida_allins.PPC_zlwhedx

PPC_zlwhedmx = _ida_allins.PPC_zlwhedmx

PPC_zlwhgwsfd = _ida_allins.PPC_zlwhgwsfd

PPC_zlwhgwsfdu = _ida_allins.PPC_zlwhgwsfdu

PPC_zlwhgwsfdx = _ida_allins.PPC_zlwhgwsfdx

PPC_zlwhgwsfdmx = _ida_allins.PPC_zlwhgwsfdmx

PPC_zlwhosd = _ida_allins.PPC_zlwhosd

PPC_zlwhosdu = _ida_allins.PPC_zlwhosdu

PPC_zlwhosdx = _ida_allins.PPC_zlwhosdx

PPC_zlwhosdmx = _ida_allins.PPC_zlwhosdmx

PPC_zlwhoud = _ida_allins.PPC_zlwhoud

PPC_zlwhoudu = _ida_allins.PPC_zlwhoudu

PPC_zlwhoudx = _ida_allins.PPC_zlwhoudx

PPC_zlwhoudmx = _ida_allins.PPC_zlwhoudmx

PPC_zlwhsplatd = _ida_allins.PPC_zlwhsplatd

PPC_zlwhsplatdu = _ida_allins.PPC_zlwhsplatdu

PPC_zlwhsplatdx = _ida_allins.PPC_zlwhsplatdx

PPC_zlwhsplatdmx = _ida_allins.PPC_zlwhsplatdmx

PPC_zlwhsplatwd = _ida_allins.PPC_zlwhsplatwd

PPC_zlwhsplatwdu = _ida_allins.PPC_zlwhsplatwdu

PPC_zlwhsplatwdx = _ida_allins.PPC_zlwhsplatwdx

PPC_zlwhsplatwdmx = _ida_allins.PPC_zlwhsplatwdmx

PPC_zlww = _ida_allins.PPC_zlww

PPC_zlwwu = _ida_allins.PPC_zlwwu

PPC_zlwwx = _ida_allins.PPC_zlwwx

PPC_zlwwmx = _ida_allins.PPC_zlwwmx

PPC_zlwwosd = _ida_allins.PPC_zlwwosd

PPC_zlwwosdu = _ida_allins.PPC_zlwwosdu

PPC_zlwwosdx = _ida_allins.PPC_zlwwosdx

PPC_zlwwosdmx = _ida_allins.PPC_zlwwosdmx

PPC_zstdd = _ida_allins.PPC_zstdd

PPC_zstddu = _ida_allins.PPC_zstddu

PPC_zstddx = _ida_allins.PPC_zstddx

PPC_zstddmx = _ida_allins.PPC_zstddmx

PPC_zstdh = _ida_allins.PPC_zstdh

PPC_zstdhu = _ida_allins.PPC_zstdhu

PPC_zstdhx = _ida_allins.PPC_zstdhx

PPC_zstdhmx = _ida_allins.PPC_zstdhmx

PPC_zstdw = _ida_allins.PPC_zstdw

PPC_zstdwu = _ida_allins.PPC_zstdwu

PPC_zstdwx = _ida_allins.PPC_zstdwx

PPC_zstdwmx = _ida_allins.PPC_zstdwmx

PPC_zsthe = _ida_allins.PPC_zsthe

PPC_zstheu = _ida_allins.PPC_zstheu

PPC_zsthex = _ida_allins.PPC_zsthex

PPC_zsthemx = _ida_allins.PPC_zsthemx

PPC_zstho = _ida_allins.PPC_zstho

PPC_zsthou = _ida_allins.PPC_zsthou

PPC_zsthox = _ida_allins.PPC_zsthox

PPC_zsthomx = _ida_allins.PPC_zsthomx

PPC_zstwh = _ida_allins.PPC_zstwh

PPC_zstwhu = _ida_allins.PPC_zstwhu

PPC_zstwhx = _ida_allins.PPC_zstwhx

PPC_zstwhmx = _ida_allins.PPC_zstwhmx

PPC_zstwhed = _ida_allins.PPC_zstwhed

PPC_zstwhedu = _ida_allins.PPC_zstwhedu

PPC_zstwhedx = _ida_allins.PPC_zstwhedx

PPC_zstwhedmx = _ida_allins.PPC_zstwhedmx

PPC_zstwhod = _ida_allins.PPC_zstwhod

PPC_zstwhodu = _ida_allins.PPC_zstwhodu

PPC_zstwhodx = _ida_allins.PPC_zstwhodx

PPC_zstwhodmx = _ida_allins.PPC_zstwhodmx

PPC_zstww = _ida_allins.PPC_zstww

PPC_zstwwu = _ida_allins.PPC_zstwwu

PPC_zstwwx = _ida_allins.PPC_zstwwx

PPC_zstwwmx = _ida_allins.PPC_zstwwmx

PPC_zmhegui = _ida_allins.PPC_zmhegui

PPC_zmhegsi = _ida_allins.PPC_zmhegsi

PPC_zmhegsui = _ida_allins.PPC_zmhegsui

PPC_zmhegsmf = _ida_allins.PPC_zmhegsmf

PPC_zmheogui = _ida_allins.PPC_zmheogui

PPC_zmheogsi = _ida_allins.PPC_zmheogsi

PPC_zmheogsui = _ida_allins.PPC_zmheogsui

PPC_zmheogsmf = _ida_allins.PPC_zmheogsmf

PPC_zmhogui = _ida_allins.PPC_zmhogui

PPC_zmhogsi = _ida_allins.PPC_zmhogsi

PPC_zmhogsui = _ida_allins.PPC_zmhogsui

PPC_zmhogsmf = _ida_allins.PPC_zmhogsmf

PPC_zmheguiaa = _ida_allins.PPC_zmheguiaa

PPC_zmheguian = _ida_allins.PPC_zmheguian

PPC_zmhegsiaa = _ida_allins.PPC_zmhegsiaa

PPC_zmhegsian = _ida_allins.PPC_zmhegsian

PPC_zmhegsuiaa = _ida_allins.PPC_zmhegsuiaa

PPC_zmhegsuian = _ida_allins.PPC_zmhegsuian

PPC_zmhegsmfaa = _ida_allins.PPC_zmhegsmfaa

PPC_zmhegsmfan = _ida_allins.PPC_zmhegsmfan

PPC_zmheoguiaa = _ida_allins.PPC_zmheoguiaa

PPC_zmheoguian = _ida_allins.PPC_zmheoguian

PPC_zmheogsiaa = _ida_allins.PPC_zmheogsiaa

PPC_zmheogsian = _ida_allins.PPC_zmheogsian

PPC_zmheogsuiaa = _ida_allins.PPC_zmheogsuiaa

PPC_zmheogsuian = _ida_allins.PPC_zmheogsuian

PPC_zmheogsmfaa = _ida_allins.PPC_zmheogsmfaa

PPC_zmheogsmfan = _ida_allins.PPC_zmheogsmfan

PPC_zmhoguiaa = _ida_allins.PPC_zmhoguiaa

PPC_zmhoguian = _ida_allins.PPC_zmhoguian

PPC_zmhogsiaa = _ida_allins.PPC_zmhogsiaa

PPC_zmhogsian = _ida_allins.PPC_zmhogsian

PPC_zmhogsuiaa = _ida_allins.PPC_zmhogsuiaa

PPC_zmhogsuian = _ida_allins.PPC_zmhogsuian

PPC_zmhogsmfaa = _ida_allins.PPC_zmhogsmfaa

PPC_zmhogsmfan = _ida_allins.PPC_zmhogsmfan

PPC_zmhegwsmf = _ida_allins.PPC_zmhegwsmf

PPC_zmheogwsmf = _ida_allins.PPC_zmheogwsmf

PPC_zmhogwsmf = _ida_allins.PPC_zmhogwsmf

PPC_zmhegwsmfr = _ida_allins.PPC_zmhegwsmfr

PPC_zmheogwsmfr = _ida_allins.PPC_zmheogwsmfr

PPC_zmhogwsmfr = _ida_allins.PPC_zmhogwsmfr

PPC_zmhegwsmfaa = _ida_allins.PPC_zmhegwsmfaa

PPC_zmheogwsmfaa = _ida_allins.PPC_zmheogwsmfaa

PPC_zmhogwsmfaa = _ida_allins.PPC_zmhogwsmfaa

PPC_zmhegwsmfan = _ida_allins.PPC_zmhegwsmfan

PPC_zmheogwsmfan = _ida_allins.PPC_zmheogwsmfan

PPC_zmhogwsmfan = _ida_allins.PPC_zmhogwsmfan

PPC_zmhegwsmfraa = _ida_allins.PPC_zmhegwsmfraa

PPC_zmheogwsmfraa = _ida_allins.PPC_zmheogwsmfraa

PPC_zmhogwsmfraa = _ida_allins.PPC_zmhogwsmfraa

PPC_zmhegwsmfran = _ida_allins.PPC_zmhegwsmfran

PPC_zmheogwsmfran = _ida_allins.PPC_zmheogwsmfran

PPC_zmhogwsmfran = _ida_allins.PPC_zmhogwsmfran

PPC_zmhesf = _ida_allins.PPC_zmhesf

PPC_zmheosf = _ida_allins.PPC_zmheosf

PPC_zmhosf = _ida_allins.PPC_zmhosf

PPC_zmhesfr = _ida_allins.PPC_zmhesfr

PPC_zmheosfr = _ida_allins.PPC_zmheosfr

PPC_zmhosfr = _ida_allins.PPC_zmhosfr

PPC_zmhesfaas = _ida_allins.PPC_zmhesfaas

PPC_zmheosfaas = _ida_allins.PPC_zmheosfaas

PPC_zmhosfaas = _ida_allins.PPC_zmhosfaas

PPC_zmhesfans = _ida_allins.PPC_zmhesfans

PPC_zmheosfans = _ida_allins.PPC_zmheosfans

PPC_zmhosfans = _ida_allins.PPC_zmhosfans

PPC_zmhesfraas = _ida_allins.PPC_zmhesfraas

PPC_zmheosfraas = _ida_allins.PPC_zmheosfraas

PPC_zmhosfraas = _ida_allins.PPC_zmhosfraas

PPC_zmhesfrans = _ida_allins.PPC_zmhesfrans

PPC_zmheosfrans = _ida_allins.PPC_zmheosfrans

PPC_zmhosfrans = _ida_allins.PPC_zmhosfrans

PPC_zmhesi = _ida_allins.PPC_zmhesi

PPC_zmheosi = _ida_allins.PPC_zmheosi

PPC_zmhosi = _ida_allins.PPC_zmhosi

PPC_zmhesui = _ida_allins.PPC_zmhesui

PPC_zmheosui = _ida_allins.PPC_zmheosui

PPC_zmhosui = _ida_allins.PPC_zmhosui

PPC_zmheui = _ida_allins.PPC_zmheui

PPC_zmheoui = _ida_allins.PPC_zmheoui

PPC_zmhoui = _ida_allins.PPC_zmhoui

PPC_zmhesiaa = _ida_allins.PPC_zmhesiaa

PPC_zmheosiaa = _ida_allins.PPC_zmheosiaa

PPC_zmhosiaa = _ida_allins.PPC_zmhosiaa

PPC_zmhesian = _ida_allins.PPC_zmhesian

PPC_zmheosian = _ida_allins.PPC_zmheosian

PPC_zmhosian = _ida_allins.PPC_zmhosian

PPC_zmhesuiaa = _ida_allins.PPC_zmhesuiaa

PPC_zmheosuiaa = _ida_allins.PPC_zmheosuiaa

PPC_zmhosuiaa = _ida_allins.PPC_zmhosuiaa

PPC_zmhesuian = _ida_allins.PPC_zmhesuian

PPC_zmheosuian = _ida_allins.PPC_zmheosuian

PPC_zmhosuian = _ida_allins.PPC_zmhosuian

PPC_zmheuiaa = _ida_allins.PPC_zmheuiaa

PPC_zmheouiaa = _ida_allins.PPC_zmheouiaa

PPC_zmhouiaa = _ida_allins.PPC_zmhouiaa

PPC_zmheuian = _ida_allins.PPC_zmheuian

PPC_zmheouian = _ida_allins.PPC_zmheouian

PPC_zmhouian = _ida_allins.PPC_zmhouian

PPC_zmhesiaas = _ida_allins.PPC_zmhesiaas

PPC_zmheosiaas = _ida_allins.PPC_zmheosiaas

PPC_zmhosiaas = _ida_allins.PPC_zmhosiaas

PPC_zmhesians = _ida_allins.PPC_zmhesians

PPC_zmheosians = _ida_allins.PPC_zmheosians

PPC_zmhosians = _ida_allins.PPC_zmhosians

PPC_zmhesuiaas = _ida_allins.PPC_zmhesuiaas

PPC_zmheosuiaas = _ida_allins.PPC_zmheosuiaas

PPC_zmhosuiaas = _ida_allins.PPC_zmhosuiaas

PPC_zmhesuians = _ida_allins.PPC_zmhesuians

PPC_zmheosuians = _ida_allins.PPC_zmheosuians

PPC_zmhosuians = _ida_allins.PPC_zmhosuians

PPC_zmheuiaas = _ida_allins.PPC_zmheuiaas

PPC_zmheouiaas = _ida_allins.PPC_zmheouiaas

PPC_zmhouiaas = _ida_allins.PPC_zmhouiaas

PPC_zmheuians = _ida_allins.PPC_zmheuians

PPC_zmheouians = _ida_allins.PPC_zmheouians

PPC_zmhouians = _ida_allins.PPC_zmhouians

PPC_zvmhsfh = _ida_allins.PPC_zvmhsfh

PPC_zvmhsfrh = _ida_allins.PPC_zvmhsfrh

PPC_zvmhsfaahs = _ida_allins.PPC_zvmhsfaahs

PPC_zvmhsfanhs = _ida_allins.PPC_zvmhsfanhs

PPC_zvmhsfraahs = _ida_allins.PPC_zvmhsfraahs

PPC_zvmhsfranhs = _ida_allins.PPC_zvmhsfranhs

PPC_zvmhsih = _ida_allins.PPC_zvmhsih

PPC_zvmhsuih = _ida_allins.PPC_zvmhsuih

PPC_zvmhuih = _ida_allins.PPC_zvmhuih

PPC_zvmhsihs = _ida_allins.PPC_zvmhsihs

PPC_zvmhsuihs = _ida_allins.PPC_zvmhsuihs

PPC_zvmhuihs = _ida_allins.PPC_zvmhuihs

PPC_zvmhsiaah = _ida_allins.PPC_zvmhsiaah

PPC_zvmhsuiaah = _ida_allins.PPC_zvmhsuiaah

PPC_zvmhuiaah = _ida_allins.PPC_zvmhuiaah

PPC_zvmhsianh = _ida_allins.PPC_zvmhsianh

PPC_zvmhsuianh = _ida_allins.PPC_zvmhsuianh

PPC_zvmhuianh = _ida_allins.PPC_zvmhuianh

PPC_zvmhsiaahs = _ida_allins.PPC_zvmhsiaahs

PPC_zvmhsuiaahs = _ida_allins.PPC_zvmhsuiaahs

PPC_zvmhuiaahs = _ida_allins.PPC_zvmhuiaahs

PPC_zvmhsianhs = _ida_allins.PPC_zvmhsianhs

PPC_zvmhsuianhs = _ida_allins.PPC_zvmhsuianhs

PPC_zvmhuianhs = _ida_allins.PPC_zvmhuianhs

PPC_zmwgsi = _ida_allins.PPC_zmwgsi

PPC_zmwgsui = _ida_allins.PPC_zmwgsui

PPC_zmwgui = _ida_allins.PPC_zmwgui

PPC_zmwgsiaa = _ida_allins.PPC_zmwgsiaa

PPC_zmwgsian = _ida_allins.PPC_zmwgsian

PPC_zmwgsuiaa = _ida_allins.PPC_zmwgsuiaa

PPC_zmwgsuian = _ida_allins.PPC_zmwgsuian

PPC_zmwguiaa = _ida_allins.PPC_zmwguiaa

PPC_zmwguian = _ida_allins.PPC_zmwguian

PPC_zmwgsiaas = _ida_allins.PPC_zmwgsiaas

PPC_zmwgsians = _ida_allins.PPC_zmwgsians

PPC_zmwgsuiaas = _ida_allins.PPC_zmwgsuiaas

PPC_zmwgsuians = _ida_allins.PPC_zmwgsuians

PPC_zmwguiaas = _ida_allins.PPC_zmwguiaas

PPC_zmwguians = _ida_allins.PPC_zmwguians

PPC_zmwgsmf = _ida_allins.PPC_zmwgsmf

PPC_zmwgsmfr = _ida_allins.PPC_zmwgsmfr

PPC_zmwgsmfaa = _ida_allins.PPC_zmwgsmfaa

PPC_zmwgsmfan = _ida_allins.PPC_zmwgsmfan

PPC_zmwgsmfraa = _ida_allins.PPC_zmwgsmfraa

PPC_zmwgsmfran = _ida_allins.PPC_zmwgsmfran

PPC_zmwlsis = _ida_allins.PPC_zmwlsis

PPC_zmwlsuis = _ida_allins.PPC_zmwlsuis

PPC_zmwluis = _ida_allins.PPC_zmwluis

PPC_zmwlsiaa = _ida_allins.PPC_zmwlsiaa

PPC_zmwlsuiaa = _ida_allins.PPC_zmwlsuiaa

PPC_zmwluiaa = _ida_allins.PPC_zmwluiaa

PPC_zmwlsian = _ida_allins.PPC_zmwlsian

PPC_zmwlsuian = _ida_allins.PPC_zmwlsuian

PPC_zmwluian = _ida_allins.PPC_zmwluian

PPC_zmwlsiaas = _ida_allins.PPC_zmwlsiaas

PPC_zmwlsuiaas = _ida_allins.PPC_zmwlsuiaas

PPC_zmwluiaas = _ida_allins.PPC_zmwluiaas

PPC_zmwlsians = _ida_allins.PPC_zmwlsians

PPC_zmwlsuians = _ida_allins.PPC_zmwlsuians

PPC_zmwluians = _ida_allins.PPC_zmwluians

PPC_zmwsf = _ida_allins.PPC_zmwsf

PPC_zmwsfr = _ida_allins.PPC_zmwsfr

PPC_zmwsfaas = _ida_allins.PPC_zmwsfaas

PPC_zmwsfans = _ida_allins.PPC_zmwsfans

PPC_zmwsfraas = _ida_allins.PPC_zmwsfraas

PPC_zmwsfrans = _ida_allins.PPC_zmwsfrans

PPC_zvmhulgwsmf = _ida_allins.PPC_zvmhulgwsmf

PPC_zvmhllgwsmf = _ida_allins.PPC_zvmhllgwsmf

PPC_zvmhuugwsmf = _ida_allins.PPC_zvmhuugwsmf

PPC_zvmhxlgwsmf = _ida_allins.PPC_zvmhxlgwsmf

PPC_zvmhulgwsmfr = _ida_allins.PPC_zvmhulgwsmfr

PPC_zvmhllgwsmfr = _ida_allins.PPC_zvmhllgwsmfr

PPC_zvmhuugwsmfr = _ida_allins.PPC_zvmhuugwsmfr

PPC_zvmhxlgwsmfr = _ida_allins.PPC_zvmhxlgwsmfr

PPC_zvmhulgwsmfaa = _ida_allins.PPC_zvmhulgwsmfaa

PPC_zvmhllgwsmfaa = _ida_allins.PPC_zvmhllgwsmfaa

PPC_zvmhuugwsmfaa = _ida_allins.PPC_zvmhuugwsmfaa

PPC_zvmhxlgwsmfaa = _ida_allins.PPC_zvmhxlgwsmfaa

PPC_zvmhulgwsmfraa = _ida_allins.PPC_zvmhulgwsmfraa

PPC_zvmhllgwsmfraa = _ida_allins.PPC_zvmhllgwsmfraa

PPC_zvmhuugwsmfraa = _ida_allins.PPC_zvmhuugwsmfraa

PPC_zvmhxlgwsmfraa = _ida_allins.PPC_zvmhxlgwsmfraa

PPC_zvmhulgwsmfan = _ida_allins.PPC_zvmhulgwsmfan

PPC_zvmhllgwsmfan = _ida_allins.PPC_zvmhllgwsmfan

PPC_zvmhuugwsmfan = _ida_allins.PPC_zvmhuugwsmfan

PPC_zvmhxlgwsmfan = _ida_allins.PPC_zvmhxlgwsmfan

PPC_zvmhulgwsmfran = _ida_allins.PPC_zvmhulgwsmfran

PPC_zvmhllgwsmfran = _ida_allins.PPC_zvmhllgwsmfran

PPC_zvmhuugwsmfran = _ida_allins.PPC_zvmhuugwsmfran

PPC_zvmhxlgwsmfran = _ida_allins.PPC_zvmhxlgwsmfran

PPC_zvmhulgwsmfanp = _ida_allins.PPC_zvmhulgwsmfanp

PPC_zvmhllgwsmfanp = _ida_allins.PPC_zvmhllgwsmfanp

PPC_zvmhuugwsmfanp = _ida_allins.PPC_zvmhuugwsmfanp

PPC_zvmhxlgwsmfanp = _ida_allins.PPC_zvmhxlgwsmfanp

PPC_zvmhulgwsmfranp = _ida_allins.PPC_zvmhulgwsmfranp

PPC_zvmhllgwsmfranp = _ida_allins.PPC_zvmhllgwsmfranp

PPC_zvmhuugwsmfranp = _ida_allins.PPC_zvmhuugwsmfranp

PPC_zvmhxlgwsmfranp = _ida_allins.PPC_zvmhxlgwsmfranp

PPC_zvmhulsf = _ida_allins.PPC_zvmhulsf

PPC_zvmhllsf = _ida_allins.PPC_zvmhllsf

PPC_zvmhuusf = _ida_allins.PPC_zvmhuusf

PPC_zvmhxlsf = _ida_allins.PPC_zvmhxlsf

PPC_zvmhulsfr = _ida_allins.PPC_zvmhulsfr

PPC_zvmhllsfr = _ida_allins.PPC_zvmhllsfr

PPC_zvmhuusfr = _ida_allins.PPC_zvmhuusfr

PPC_zvmhxlsfr = _ida_allins.PPC_zvmhxlsfr

PPC_zvmhulsfaas = _ida_allins.PPC_zvmhulsfaas

PPC_zvmhllsfaas = _ida_allins.PPC_zvmhllsfaas

PPC_zvmhuusfaas = _ida_allins.PPC_zvmhuusfaas

PPC_zvmhxlsfaas = _ida_allins.PPC_zvmhxlsfaas

PPC_zvmhulsfans = _ida_allins.PPC_zvmhulsfans

PPC_zvmhllsfans = _ida_allins.PPC_zvmhllsfans

PPC_zvmhuusfans = _ida_allins.PPC_zvmhuusfans

PPC_zvmhxlsfans = _ida_allins.PPC_zvmhxlsfans

PPC_zvmhulsfanps = _ida_allins.PPC_zvmhulsfanps

PPC_zvmhllsfanps = _ida_allins.PPC_zvmhllsfanps

PPC_zvmhuusfanps = _ida_allins.PPC_zvmhuusfanps

PPC_zvmhxlsfanps = _ida_allins.PPC_zvmhxlsfanps

PPC_zvmhulsfraas = _ida_allins.PPC_zvmhulsfraas

PPC_zvmhllsfraas = _ida_allins.PPC_zvmhllsfraas

PPC_zvmhuusfraas = _ida_allins.PPC_zvmhuusfraas

PPC_zvmhxlsfraas = _ida_allins.PPC_zvmhxlsfraas

PPC_zvmhulsfrans = _ida_allins.PPC_zvmhulsfrans

PPC_zvmhllsfrans = _ida_allins.PPC_zvmhllsfrans

PPC_zvmhuusfrans = _ida_allins.PPC_zvmhuusfrans

PPC_zvmhxlsfrans = _ida_allins.PPC_zvmhxlsfrans

PPC_zvmhulsfranps = _ida_allins.PPC_zvmhulsfranps

PPC_zvmhllsfranps = _ida_allins.PPC_zvmhllsfranps

PPC_zvmhuusfranps = _ida_allins.PPC_zvmhuusfranps

PPC_zvmhxlsfranps = _ida_allins.PPC_zvmhxlsfranps

PPC_zvmhulsi = _ida_allins.PPC_zvmhulsi

PPC_zvmhllsi = _ida_allins.PPC_zvmhllsi

PPC_zvmhuusi = _ida_allins.PPC_zvmhuusi

PPC_zvmhxlsi = _ida_allins.PPC_zvmhxlsi

PPC_zvmhulsui = _ida_allins.PPC_zvmhulsui

PPC_zvmhllsui = _ida_allins.PPC_zvmhllsui

PPC_zvmhuusui = _ida_allins.PPC_zvmhuusui

PPC_zvmhxlsui = _ida_allins.PPC_zvmhxlsui

PPC_zvmhului = _ida_allins.PPC_zvmhului

PPC_zvmhllui = _ida_allins.PPC_zvmhllui

PPC_zvmhuuui = _ida_allins.PPC_zvmhuuui

PPC_zvmhxlui = _ida_allins.PPC_zvmhxlui

PPC_zvmhulsiaa = _ida_allins.PPC_zvmhulsiaa

PPC_zvmhllsiaa = _ida_allins.PPC_zvmhllsiaa

PPC_zvmhuusiaa = _ida_allins.PPC_zvmhuusiaa

PPC_zvmhxlsiaa = _ida_allins.PPC_zvmhxlsiaa

PPC_zvmhulsian = _ida_allins.PPC_zvmhulsian

PPC_zvmhllsian = _ida_allins.PPC_zvmhllsian

PPC_zvmhuusian = _ida_allins.PPC_zvmhuusian

PPC_zvmhxlsian = _ida_allins.PPC_zvmhxlsian

PPC_zvmhulsianp = _ida_allins.PPC_zvmhulsianp

PPC_zvmhllsianp = _ida_allins.PPC_zvmhllsianp

PPC_zvmhuusianp = _ida_allins.PPC_zvmhuusianp

PPC_zvmhxlsianp = _ida_allins.PPC_zvmhxlsianp

PPC_zvmhulsuiaa = _ida_allins.PPC_zvmhulsuiaa

PPC_zvmhllsuiaa = _ida_allins.PPC_zvmhllsuiaa

PPC_zvmhuusuiaa = _ida_allins.PPC_zvmhuusuiaa

PPC_zvmhxlsuiaa = _ida_allins.PPC_zvmhxlsuiaa

PPC_zvmhulsuian = _ida_allins.PPC_zvmhulsuian

PPC_zvmhllsuian = _ida_allins.PPC_zvmhllsuian

PPC_zvmhuusuian = _ida_allins.PPC_zvmhuusuian

PPC_zvmhxlsuian = _ida_allins.PPC_zvmhxlsuian

PPC_zvmhulsuianp = _ida_allins.PPC_zvmhulsuianp

PPC_zvmhllsuianp = _ida_allins.PPC_zvmhllsuianp

PPC_zvmhuusuianp = _ida_allins.PPC_zvmhuusuianp

PPC_zvmhxlsuianp = _ida_allins.PPC_zvmhxlsuianp

PPC_zvmhuluiaa = _ida_allins.PPC_zvmhuluiaa

PPC_zvmhlluiaa = _ida_allins.PPC_zvmhlluiaa

PPC_zvmhuuuiaa = _ida_allins.PPC_zvmhuuuiaa

PPC_zvmhxluiaa = _ida_allins.PPC_zvmhxluiaa

PPC_zvmhuluian = _ida_allins.PPC_zvmhuluian

PPC_zvmhlluian = _ida_allins.PPC_zvmhlluian

PPC_zvmhuuuian = _ida_allins.PPC_zvmhuuuian

PPC_zvmhxluian = _ida_allins.PPC_zvmhxluian

PPC_zvmhuluianp = _ida_allins.PPC_zvmhuluianp

PPC_zvmhlluianp = _ida_allins.PPC_zvmhlluianp

PPC_zvmhuuuianp = _ida_allins.PPC_zvmhuuuianp

PPC_zvmhxluianp = _ida_allins.PPC_zvmhxluianp

PPC_zvmhulsiaas = _ida_allins.PPC_zvmhulsiaas

PPC_zvmhllsiaas = _ida_allins.PPC_zvmhllsiaas

PPC_zvmhuusiaas = _ida_allins.PPC_zvmhuusiaas

PPC_zvmhxlsiaas = _ida_allins.PPC_zvmhxlsiaas

PPC_zvmhulsians = _ida_allins.PPC_zvmhulsians

PPC_zvmhllsians = _ida_allins.PPC_zvmhllsians

PPC_zvmhuusians = _ida_allins.PPC_zvmhuusians

PPC_zvmhxlsians = _ida_allins.PPC_zvmhxlsians

PPC_zvmhulsianps = _ida_allins.PPC_zvmhulsianps

PPC_zvmhllsianps = _ida_allins.PPC_zvmhllsianps

PPC_zvmhuusianps = _ida_allins.PPC_zvmhuusianps

PPC_zvmhxlsianps = _ida_allins.PPC_zvmhxlsianps

PPC_zvmhulsuiaas = _ida_allins.PPC_zvmhulsuiaas

PPC_zvmhllsuiaas = _ida_allins.PPC_zvmhllsuiaas

PPC_zvmhuusuiaas = _ida_allins.PPC_zvmhuusuiaas

PPC_zvmhxlsuiaas = _ida_allins.PPC_zvmhxlsuiaas

PPC_zvmhulsuians = _ida_allins.PPC_zvmhulsuians

PPC_zvmhllsuians = _ida_allins.PPC_zvmhllsuians

PPC_zvmhuusuians = _ida_allins.PPC_zvmhuusuians

PPC_zvmhxlsuians = _ida_allins.PPC_zvmhxlsuians

PPC_zvmhulsuianps = _ida_allins.PPC_zvmhulsuianps

PPC_zvmhllsuianps = _ida_allins.PPC_zvmhllsuianps

PPC_zvmhuusuianps = _ida_allins.PPC_zvmhuusuianps

PPC_zvmhxlsuianps = _ida_allins.PPC_zvmhxlsuianps

PPC_zvmhuluiaas = _ida_allins.PPC_zvmhuluiaas

PPC_zvmhlluiaas = _ida_allins.PPC_zvmhlluiaas

PPC_zvmhuuuiaas = _ida_allins.PPC_zvmhuuuiaas

PPC_zvmhxluiaas = _ida_allins.PPC_zvmhxluiaas

PPC_zvmhuluians = _ida_allins.PPC_zvmhuluians

PPC_zvmhlluians = _ida_allins.PPC_zvmhlluians

PPC_zvmhuuuians = _ida_allins.PPC_zvmhuuuians

PPC_zvmhxluians = _ida_allins.PPC_zvmhxluians

PPC_zvmhuluianps = _ida_allins.PPC_zvmhuluianps

PPC_zvmhlluianps = _ida_allins.PPC_zvmhlluianps

PPC_zvmhuuuianps = _ida_allins.PPC_zvmhuuuianps

PPC_zvmhxluianps = _ida_allins.PPC_zvmhxluianps

PPC_zvdotphgaui = _ida_allins.PPC_zvdotphgaui

PPC_zvdotphxgaui = _ida_allins.PPC_zvdotphxgaui

PPC_zvdotphgasi = _ida_allins.PPC_zvdotphgasi

PPC_zvdotphxgasi = _ida_allins.PPC_zvdotphxgasi

PPC_zvdotphgasui = _ida_allins.PPC_zvdotphgasui

PPC_zvdotphxgasui = _ida_allins.PPC_zvdotphxgasui

PPC_zvdotphgasmf = _ida_allins.PPC_zvdotphgasmf

PPC_zvdotphxgasmf = _ida_allins.PPC_zvdotphxgasmf

PPC_zvdotphgauiaa = _ida_allins.PPC_zvdotphgauiaa

PPC_zvdotphxgauiaa = _ida_allins.PPC_zvdotphxgauiaa

PPC_zvdotphgasiaa = _ida_allins.PPC_zvdotphgasiaa

PPC_zvdotphxgasiaa = _ida_allins.PPC_zvdotphxgasiaa

PPC_zvdotphgasuiaa = _ida_allins.PPC_zvdotphgasuiaa

PPC_zvdotphxgasuiaa = _ida_allins.PPC_zvdotphxgasuiaa

PPC_zvdotphgasmfaa = _ida_allins.PPC_zvdotphgasmfaa

PPC_zvdotphxgasmfaa = _ida_allins.PPC_zvdotphxgasmfaa

PPC_zvdotphgauian = _ida_allins.PPC_zvdotphgauian

PPC_zvdotphxgauian = _ida_allins.PPC_zvdotphxgauian

PPC_zvdotphgasian = _ida_allins.PPC_zvdotphgasian

PPC_zvdotphxgasian = _ida_allins.PPC_zvdotphxgasian

PPC_zvdotphgasuian = _ida_allins.PPC_zvdotphgasuian

PPC_zvdotphxgasuian = _ida_allins.PPC_zvdotphxgasuian

PPC_zvdotphgasmfan = _ida_allins.PPC_zvdotphgasmfan

PPC_zvdotphxgasmfan = _ida_allins.PPC_zvdotphxgasmfan

PPC_zvdotphgsui = _ida_allins.PPC_zvdotphgsui

PPC_zvdotphgssi = _ida_allins.PPC_zvdotphgssi

PPC_zvdotphgssui = _ida_allins.PPC_zvdotphgssui

PPC_zvdotphgssmf = _ida_allins.PPC_zvdotphgssmf

PPC_zvdotphgsuiaa = _ida_allins.PPC_zvdotphgsuiaa

PPC_zvdotphgssiaa = _ida_allins.PPC_zvdotphgssiaa

PPC_zvdotphgssuiaa = _ida_allins.PPC_zvdotphgssuiaa

PPC_zvdotphgssmfaa = _ida_allins.PPC_zvdotphgssmfaa

PPC_zvdotphgsuian = _ida_allins.PPC_zvdotphgsuian

PPC_zvdotphgssian = _ida_allins.PPC_zvdotphgssian

PPC_zvdotphgssuian = _ida_allins.PPC_zvdotphgssuian

PPC_zvdotphgssmfan = _ida_allins.PPC_zvdotphgssmfan

PPC_zvdotphasfs = _ida_allins.PPC_zvdotphasfs

PPC_zvdotphxasfs = _ida_allins.PPC_zvdotphxasfs

PPC_zvdotphasfrs = _ida_allins.PPC_zvdotphasfrs

PPC_zvdotphxasfrs = _ida_allins.PPC_zvdotphxasfrs

PPC_zvdotphasfaas = _ida_allins.PPC_zvdotphasfaas

PPC_zvdotphxasfaas = _ida_allins.PPC_zvdotphxasfaas

PPC_zvdotphasfans = _ida_allins.PPC_zvdotphasfans

PPC_zvdotphxasfans = _ida_allins.PPC_zvdotphxasfans

PPC_zvdotphasfraas = _ida_allins.PPC_zvdotphasfraas

PPC_zvdotphxasfraas = _ida_allins.PPC_zvdotphxasfraas

PPC_zvdotphasfrans = _ida_allins.PPC_zvdotphasfrans

PPC_zvdotphxasfrans = _ida_allins.PPC_zvdotphxasfrans

PPC_zvdotphaui = _ida_allins.PPC_zvdotphaui

PPC_zvdotphxaui = _ida_allins.PPC_zvdotphxaui

PPC_zvdotphasi = _ida_allins.PPC_zvdotphasi

PPC_zvdotphxasi = _ida_allins.PPC_zvdotphxasi

PPC_zvdotphasui = _ida_allins.PPC_zvdotphasui

PPC_zvdotphxasui = _ida_allins.PPC_zvdotphxasui

PPC_zvdotphauiaa = _ida_allins.PPC_zvdotphauiaa

PPC_zvdotphxauiaa = _ida_allins.PPC_zvdotphxauiaa

PPC_zvdotphasiaa = _ida_allins.PPC_zvdotphasiaa

PPC_zvdotphxasiaa = _ida_allins.PPC_zvdotphxasiaa

PPC_zvdotphasuiaa = _ida_allins.PPC_zvdotphasuiaa

PPC_zvdotphxasuiaa = _ida_allins.PPC_zvdotphxasuiaa

PPC_zvdotphauian = _ida_allins.PPC_zvdotphauian

PPC_zvdotphxauian = _ida_allins.PPC_zvdotphxauian

PPC_zvdotphasian = _ida_allins.PPC_zvdotphasian

PPC_zvdotphxasian = _ida_allins.PPC_zvdotphxasian

PPC_zvdotphasuian = _ida_allins.PPC_zvdotphasuian

PPC_zvdotphxasuian = _ida_allins.PPC_zvdotphxasuian

PPC_zvdotphauis = _ida_allins.PPC_zvdotphauis

PPC_zvdotphxauis = _ida_allins.PPC_zvdotphxauis

PPC_zvdotphasis = _ida_allins.PPC_zvdotphasis

PPC_zvdotphxasis = _ida_allins.PPC_zvdotphxasis

PPC_zvdotphasuis = _ida_allins.PPC_zvdotphasuis

PPC_zvdotphxasuis = _ida_allins.PPC_zvdotphxasuis

PPC_zvdotphauiaas = _ida_allins.PPC_zvdotphauiaas

PPC_zvdotphxauiaas = _ida_allins.PPC_zvdotphxauiaas

PPC_zvdotphasiaas = _ida_allins.PPC_zvdotphasiaas

PPC_zvdotphxasiaas = _ida_allins.PPC_zvdotphxasiaas

PPC_zvdotphasuiaas = _ida_allins.PPC_zvdotphasuiaas

PPC_zvdotphxasuiaas = _ida_allins.PPC_zvdotphxasuiaas

PPC_zvdotphauians = _ida_allins.PPC_zvdotphauians

PPC_zvdotphxauians = _ida_allins.PPC_zvdotphxauians

PPC_zvdotphasians = _ida_allins.PPC_zvdotphasians

PPC_zvdotphxasians = _ida_allins.PPC_zvdotphxasians

PPC_zvdotphasuians = _ida_allins.PPC_zvdotphasuians

PPC_zvdotphxasuians = _ida_allins.PPC_zvdotphxasuians

PPC_zvdotphssfs = _ida_allins.PPC_zvdotphssfs

PPC_zvdotphssfrs = _ida_allins.PPC_zvdotphssfrs

PPC_zvdotphssfaas = _ida_allins.PPC_zvdotphssfaas

PPC_zvdotphssfans = _ida_allins.PPC_zvdotphssfans

PPC_zvdotphssfraas = _ida_allins.PPC_zvdotphssfraas

PPC_zvdotphssfrans = _ida_allins.PPC_zvdotphssfrans

PPC_zvdotphsui = _ida_allins.PPC_zvdotphsui

PPC_zvdotphssi = _ida_allins.PPC_zvdotphssi

PPC_zvdotphssui = _ida_allins.PPC_zvdotphssui

PPC_zvdotphsuiaa = _ida_allins.PPC_zvdotphsuiaa

PPC_zvdotphssiaa = _ida_allins.PPC_zvdotphssiaa

PPC_zvdotphssuiaa = _ida_allins.PPC_zvdotphssuiaa

PPC_zvdotphsuian = _ida_allins.PPC_zvdotphsuian

PPC_zvdotphssian = _ida_allins.PPC_zvdotphssian

PPC_zvdotphssuian = _ida_allins.PPC_zvdotphssuian

PPC_zvdotphsuis = _ida_allins.PPC_zvdotphsuis

PPC_zvdotphssis = _ida_allins.PPC_zvdotphssis

PPC_zvdotphssuis = _ida_allins.PPC_zvdotphssuis

PPC_zvdotphsuiaas = _ida_allins.PPC_zvdotphsuiaas

PPC_zvdotphssiaas = _ida_allins.PPC_zvdotphssiaas

PPC_zvdotphssuiaas = _ida_allins.PPC_zvdotphssuiaas

PPC_zvdotphsuians = _ida_allins.PPC_zvdotphsuians

PPC_zvdotphssians = _ida_allins.PPC_zvdotphssians

PPC_zvdotphssuians = _ida_allins.PPC_zvdotphssuians

PPC_zvdotphgwasmf = _ida_allins.PPC_zvdotphgwasmf

PPC_zvdotphxgwasmf = _ida_allins.PPC_zvdotphxgwasmf

PPC_zvdotphgwasmfr = _ida_allins.PPC_zvdotphgwasmfr

PPC_zvdotphxgwasmfr = _ida_allins.PPC_zvdotphxgwasmfr

PPC_zvdotphgwasmfaa = _ida_allins.PPC_zvdotphgwasmfaa

PPC_zvdotphxgwasmfaa = _ida_allins.PPC_zvdotphxgwasmfaa

PPC_zvdotphgwasmfan = _ida_allins.PPC_zvdotphgwasmfan

PPC_zvdotphxgwasmfan = _ida_allins.PPC_zvdotphxgwasmfan

PPC_zvdotphgwasmfraa = _ida_allins.PPC_zvdotphgwasmfraa

PPC_zvdotphxgwasmfraa = _ida_allins.PPC_zvdotphxgwasmfraa

PPC_zvdotphgwasmfran = _ida_allins.PPC_zvdotphgwasmfran

PPC_zvdotphxgwasmfran = _ida_allins.PPC_zvdotphxgwasmfran

PPC_zvdotphgwssmf = _ida_allins.PPC_zvdotphgwssmf

PPC_zvdotphgwssmfr = _ida_allins.PPC_zvdotphgwssmfr

PPC_zvdotphgwssmfaa = _ida_allins.PPC_zvdotphgwssmfaa

PPC_zvdotphgwssmfan = _ida_allins.PPC_zvdotphgwssmfan

PPC_zvdotphgwssmfraa = _ida_allins.PPC_zvdotphgwssmfraa

PPC_zvdotphgwssmfran = _ida_allins.PPC_zvdotphgwssmfran

PPC_msgclru = _ida_allins.PPC_msgclru

PPC_msgsndu = _ida_allins.PPC_msgsndu

PPC_urfid = _ida_allins.PPC_urfid

PPC_paddi = _ida_allins.PPC_paddi

PPC_plbz = _ida_allins.PPC_plbz

PPC_pld = _ida_allins.PPC_pld

PPC_plfd = _ida_allins.PPC_plfd

PPC_plfs = _ida_allins.PPC_plfs

PPC_plha = _ida_allins.PPC_plha

PPC_plhz = _ida_allins.PPC_plhz

PPC_plq = _ida_allins.PPC_plq

PPC_plwa = _ida_allins.PPC_plwa

PPC_plwz = _ida_allins.PPC_plwz

PPC_plxsd = _ida_allins.PPC_plxsd

PPC_plxssp = _ida_allins.PPC_plxssp

PPC_plxv = _ida_allins.PPC_plxv

PPC_plxvp = _ida_allins.PPC_plxvp

PPC_pmxvbf16ger2 = _ida_allins.PPC_pmxvbf16ger2

PPC_pmxvbf16ger2nn = _ida_allins.PPC_pmxvbf16ger2nn

PPC_pmxvbf16ger2np = _ida_allins.PPC_pmxvbf16ger2np

PPC_pmxvbf16ger2pn = _ida_allins.PPC_pmxvbf16ger2pn

PPC_pmxvbf16ger2pp = _ida_allins.PPC_pmxvbf16ger2pp

PPC_pmxvf16ger2 = _ida_allins.PPC_pmxvf16ger2

PPC_pmxvf16ger2nn = _ida_allins.PPC_pmxvf16ger2nn

PPC_pmxvf16ger2np = _ida_allins.PPC_pmxvf16ger2np

PPC_pmxvf16ger2pn = _ida_allins.PPC_pmxvf16ger2pn

PPC_pmxvf16ger2pp = _ida_allins.PPC_pmxvf16ger2pp

PPC_pmxvf32ger = _ida_allins.PPC_pmxvf32ger

PPC_pmxvf32gernn = _ida_allins.PPC_pmxvf32gernn

PPC_pmxvf32gernp = _ida_allins.PPC_pmxvf32gernp

PPC_pmxvf32gerpn = _ida_allins.PPC_pmxvf32gerpn

PPC_pmxvf32gerpp = _ida_allins.PPC_pmxvf32gerpp

PPC_pmxvf64ger = _ida_allins.PPC_pmxvf64ger

PPC_pmxvf64gernn = _ida_allins.PPC_pmxvf64gernn

PPC_pmxvf64gernp = _ida_allins.PPC_pmxvf64gernp

PPC_pmxvf64gerpn = _ida_allins.PPC_pmxvf64gerpn

PPC_pmxvf64gerpp = _ida_allins.PPC_pmxvf64gerpp

PPC_pmxvi16ger2 = _ida_allins.PPC_pmxvi16ger2

PPC_pmxvi16ger2pp = _ida_allins.PPC_pmxvi16ger2pp

PPC_pmxvi16ger2s = _ida_allins.PPC_pmxvi16ger2s

PPC_pmxvi16ger2spp = _ida_allins.PPC_pmxvi16ger2spp

PPC_pmxvi4ger8 = _ida_allins.PPC_pmxvi4ger8

PPC_pmxvi4ger8pp = _ida_allins.PPC_pmxvi4ger8pp

PPC_pmxvi8ger4 = _ida_allins.PPC_pmxvi8ger4

PPC_pmxvi8ger4pp = _ida_allins.PPC_pmxvi8ger4pp

PPC_pmxvi8ger4spp = _ida_allins.PPC_pmxvi8ger4spp

PPC_pnop = _ida_allins.PPC_pnop

PPC_pstb = _ida_allins.PPC_pstb

PPC_pstd = _ida_allins.PPC_pstd

PPC_pstfd = _ida_allins.PPC_pstfd

PPC_pstfs = _ida_allins.PPC_pstfs

PPC_psth = _ida_allins.PPC_psth

PPC_pstq = _ida_allins.PPC_pstq

PPC_pstw = _ida_allins.PPC_pstw

PPC_pstxsd = _ida_allins.PPC_pstxsd

PPC_pstxssp = _ida_allins.PPC_pstxssp

PPC_pstxv = _ida_allins.PPC_pstxv

PPC_pstxvp = _ida_allins.PPC_pstxvp

PPC_brd = _ida_allins.PPC_brd

PPC_brh = _ida_allins.PPC_brh

PPC_brw = _ida_allins.PPC_brw

PPC_cfuged = _ida_allins.PPC_cfuged

PPC_cntlzdm = _ida_allins.PPC_cntlzdm

PPC_cnttzdm = _ida_allins.PPC_cnttzdm

PPC_dcffixqq = _ida_allins.PPC_dcffixqq

PPC_dctfixqq = _ida_allins.PPC_dctfixqq

PPC_lxvkq = _ida_allins.PPC_lxvkq

PPC_lxvp = _ida_allins.PPC_lxvp

PPC_lxvpx = _ida_allins.PPC_lxvpx

PPC_lxvrbx = _ida_allins.PPC_lxvrbx

PPC_lxvrdx = _ida_allins.PPC_lxvrdx

PPC_lxvrhx = _ida_allins.PPC_lxvrhx

PPC_lxvrwx = _ida_allins.PPC_lxvrwx

PPC_mtvsrbm = _ida_allins.PPC_mtvsrbm

PPC_mtvsrbmi = _ida_allins.PPC_mtvsrbmi

PPC_mtvsrdm = _ida_allins.PPC_mtvsrdm

PPC_mtvsrhm = _ida_allins.PPC_mtvsrhm

PPC_mtvsrqm = _ida_allins.PPC_mtvsrqm

PPC_mtvsrwm = _ida_allins.PPC_mtvsrwm

PPC_pdepd = _ida_allins.PPC_pdepd

PPC_pextd = _ida_allins.PPC_pextd

PPC_setbc = _ida_allins.PPC_setbc

PPC_setbcr = _ida_allins.PPC_setbcr

PPC_setnbc = _ida_allins.PPC_setnbc

PPC_setnbcr = _ida_allins.PPC_setnbcr

PPC_stxvp = _ida_allins.PPC_stxvp

PPC_stxvpx = _ida_allins.PPC_stxvpx

PPC_stxvrbx = _ida_allins.PPC_stxvrbx

PPC_stxvrdx = _ida_allins.PPC_stxvrdx

PPC_stxvrhx = _ida_allins.PPC_stxvrhx

PPC_stxvrwx = _ida_allins.PPC_stxvrwx

PPC_vcfuged = _ida_allins.PPC_vcfuged

PPC_vclrlb = _ida_allins.PPC_vclrlb

PPC_vclrrb = _ida_allins.PPC_vclrrb

PPC_vclzdm = _ida_allins.PPC_vclzdm

PPC_vcmpequq = _ida_allins.PPC_vcmpequq

PPC_vcmpgtsq = _ida_allins.PPC_vcmpgtsq

PPC_vcmpgtuq = _ida_allins.PPC_vcmpgtuq

PPC_vcmpsq = _ida_allins.PPC_vcmpsq

PPC_vcmpuq = _ida_allins.PPC_vcmpuq

PPC_vcntmbb = _ida_allins.PPC_vcntmbb

PPC_vcntmbd = _ida_allins.PPC_vcntmbd

PPC_vcntmbh = _ida_allins.PPC_vcntmbh

PPC_vcntmbw = _ida_allins.PPC_vcntmbw

PPC_vctzdm = _ida_allins.PPC_vctzdm

PPC_vdivesd = _ida_allins.PPC_vdivesd

PPC_vdivesq = _ida_allins.PPC_vdivesq

PPC_vdivesw = _ida_allins.PPC_vdivesw

PPC_vdiveud = _ida_allins.PPC_vdiveud

PPC_vdiveuq = _ida_allins.PPC_vdiveuq

PPC_vdiveuw = _ida_allins.PPC_vdiveuw

PPC_vdivsd = _ida_allins.PPC_vdivsd

PPC_vdivsq = _ida_allins.PPC_vdivsq

PPC_vdivsw = _ida_allins.PPC_vdivsw

PPC_vdivud = _ida_allins.PPC_vdivud

PPC_vdivuq = _ida_allins.PPC_vdivuq

PPC_vdivuw = _ida_allins.PPC_vdivuw

PPC_vexpandbm = _ida_allins.PPC_vexpandbm

PPC_vexpanddm = _ida_allins.PPC_vexpanddm

PPC_vexpandhm = _ida_allins.PPC_vexpandhm

PPC_vexpandqm = _ida_allins.PPC_vexpandqm

PPC_vexpandwm = _ida_allins.PPC_vexpandwm

PPC_vextddvlx = _ida_allins.PPC_vextddvlx

PPC_vextddvrx = _ida_allins.PPC_vextddvrx

PPC_vextdubvlx = _ida_allins.PPC_vextdubvlx

PPC_vextdubvrx = _ida_allins.PPC_vextdubvrx

PPC_vextduhvlx = _ida_allins.PPC_vextduhvlx

PPC_vextduhvrx = _ida_allins.PPC_vextduhvrx

PPC_vextduwvlx = _ida_allins.PPC_vextduwvlx

PPC_vextduwvrx = _ida_allins.PPC_vextduwvrx

PPC_vextractbm = _ida_allins.PPC_vextractbm

PPC_vextractdm = _ida_allins.PPC_vextractdm

PPC_vextracthm = _ida_allins.PPC_vextracthm

PPC_vextractqm = _ida_allins.PPC_vextractqm

PPC_vextractwm = _ida_allins.PPC_vextractwm

PPC_vextsd2q = _ida_allins.PPC_vextsd2q

PPC_vgnb = _ida_allins.PPC_vgnb

PPC_vinsblx = _ida_allins.PPC_vinsblx

PPC_vinsbrx = _ida_allins.PPC_vinsbrx

PPC_vinsbvlx = _ida_allins.PPC_vinsbvlx

PPC_vinsbvrx = _ida_allins.PPC_vinsbvrx

PPC_vinsd = _ida_allins.PPC_vinsd

PPC_vinsdlx = _ida_allins.PPC_vinsdlx

PPC_vinsdrx = _ida_allins.PPC_vinsdrx

PPC_vinshlx = _ida_allins.PPC_vinshlx

PPC_vinshrx = _ida_allins.PPC_vinshrx

PPC_vinshvlx = _ida_allins.PPC_vinshvlx

PPC_vinshvrx = _ida_allins.PPC_vinshvrx

PPC_vinsw = _ida_allins.PPC_vinsw

PPC_vinswlx = _ida_allins.PPC_vinswlx

PPC_vinswrx = _ida_allins.PPC_vinswrx

PPC_vinswvlx = _ida_allins.PPC_vinswvlx

PPC_vinswvrx = _ida_allins.PPC_vinswvrx

PPC_vmodsd = _ida_allins.PPC_vmodsd

PPC_vmodsq = _ida_allins.PPC_vmodsq

PPC_vmodsw = _ida_allins.PPC_vmodsw

PPC_vmodud = _ida_allins.PPC_vmodud

PPC_vmoduq = _ida_allins.PPC_vmoduq

PPC_vmoduw = _ida_allins.PPC_vmoduw

PPC_vmsumcud = _ida_allins.PPC_vmsumcud

PPC_vmulesd = _ida_allins.PPC_vmulesd

PPC_vmuleud = _ida_allins.PPC_vmuleud

PPC_vmulhsd = _ida_allins.PPC_vmulhsd

PPC_vmulhsw = _ida_allins.PPC_vmulhsw

PPC_vmulhud = _ida_allins.PPC_vmulhud

PPC_vmulhuw = _ida_allins.PPC_vmulhuw

PPC_vmulld = _ida_allins.PPC_vmulld

PPC_vmulosd = _ida_allins.PPC_vmulosd

PPC_vmuloud = _ida_allins.PPC_vmuloud

PPC_vpdepd = _ida_allins.PPC_vpdepd

PPC_vpextd = _ida_allins.PPC_vpextd

PPC_vrlq = _ida_allins.PPC_vrlq

PPC_vrlqmi = _ida_allins.PPC_vrlqmi

PPC_vrlqnm = _ida_allins.PPC_vrlqnm

PPC_vsldbi = _ida_allins.PPC_vsldbi

PPC_vslq = _ida_allins.PPC_vslq

PPC_vsraq = _ida_allins.PPC_vsraq

PPC_vsrdbi = _ida_allins.PPC_vsrdbi

PPC_vsrq = _ida_allins.PPC_vsrq

PPC_vstribl = _ida_allins.PPC_vstribl

PPC_vstribr = _ida_allins.PPC_vstribr

PPC_vstrihl = _ida_allins.PPC_vstrihl

PPC_vstrihr = _ida_allins.PPC_vstrihr

PPC_xscmpeqqp = _ida_allins.PPC_xscmpeqqp

PPC_xscmpgeqp = _ida_allins.PPC_xscmpgeqp

PPC_xscmpgtqp = _ida_allins.PPC_xscmpgtqp

PPC_xscvqpsqz = _ida_allins.PPC_xscvqpsqz

PPC_xscvqpuqz = _ida_allins.PPC_xscvqpuqz

PPC_xscvsqqp = _ida_allins.PPC_xscvsqqp

PPC_xscvuqqp = _ida_allins.PPC_xscvuqqp

PPC_xsmaxcqp = _ida_allins.PPC_xsmaxcqp

PPC_xsmincqp = _ida_allins.PPC_xsmincqp

PPC_xvbf16ger2 = _ida_allins.PPC_xvbf16ger2

PPC_xvbf16ger2nn = _ida_allins.PPC_xvbf16ger2nn

PPC_xvbf16ger2np = _ida_allins.PPC_xvbf16ger2np

PPC_xvbf16ger2pn = _ida_allins.PPC_xvbf16ger2pn

PPC_xvbf16ger2pp = _ida_allins.PPC_xvbf16ger2pp

PPC_xvcvbf16spn = _ida_allins.PPC_xvcvbf16spn

PPC_xvcvspbf16 = _ida_allins.PPC_xvcvspbf16

PPC_xvf16ger2 = _ida_allins.PPC_xvf16ger2

PPC_xvf16ger2nn = _ida_allins.PPC_xvf16ger2nn

PPC_xvf16ger2np = _ida_allins.PPC_xvf16ger2np

PPC_xvf16ger2pn = _ida_allins.PPC_xvf16ger2pn

PPC_xvf16ger2pp = _ida_allins.PPC_xvf16ger2pp

PPC_xvf32ger = _ida_allins.PPC_xvf32ger

PPC_xvf32gernn = _ida_allins.PPC_xvf32gernn

PPC_xvf32gernp = _ida_allins.PPC_xvf32gernp

PPC_xvf32gerpn = _ida_allins.PPC_xvf32gerpn

PPC_xvf32gerpp = _ida_allins.PPC_xvf32gerpp

PPC_xvf64ger = _ida_allins.PPC_xvf64ger

PPC_xvf64gernn = _ida_allins.PPC_xvf64gernn

PPC_xvf64gernp = _ida_allins.PPC_xvf64gernp

PPC_xvf64gerpn = _ida_allins.PPC_xvf64gerpn

PPC_xvf64gerpp = _ida_allins.PPC_xvf64gerpp

PPC_xvi16ger2 = _ida_allins.PPC_xvi16ger2

PPC_xvi16ger2pp = _ida_allins.PPC_xvi16ger2pp

PPC_xvi16ger2s = _ida_allins.PPC_xvi16ger2s

PPC_xvi16ger2spp = _ida_allins.PPC_xvi16ger2spp

PPC_xvi4ger8 = _ida_allins.PPC_xvi4ger8

PPC_xvi4ger8pp = _ida_allins.PPC_xvi4ger8pp

PPC_xvi8ger4 = _ida_allins.PPC_xvi8ger4

PPC_xvi8ger4pp = _ida_allins.PPC_xvi8ger4pp

PPC_xvi8ger4spp = _ida_allins.PPC_xvi8ger4spp

PPC_xvtlsbb = _ida_allins.PPC_xvtlsbb

PPC_xxblendvb = _ida_allins.PPC_xxblendvb

PPC_xxblendvd = _ida_allins.PPC_xxblendvd

PPC_xxblendvh = _ida_allins.PPC_xxblendvh

PPC_xxblendvw = _ida_allins.PPC_xxblendvw

PPC_xxeval = _ida_allins.PPC_xxeval

PPC_xxgenpcvbm = _ida_allins.PPC_xxgenpcvbm

PPC_xxgenpcvdm = _ida_allins.PPC_xxgenpcvdm

PPC_xxgenpcvhm = _ida_allins.PPC_xxgenpcvhm

PPC_xxgenpcvwm = _ida_allins.PPC_xxgenpcvwm

PPC_xxmfacc = _ida_allins.PPC_xxmfacc

PPC_xxmtacc = _ida_allins.PPC_xxmtacc

PPC_xxpermx = _ida_allins.PPC_xxpermx

PPC_xxsetaccz = _ida_allins.PPC_xxsetaccz

PPC_xxsplti32dx = _ida_allins.PPC_xxsplti32dx

PPC_xxspltidp = _ida_allins.PPC_xxspltidp

PPC_xxspltiw = _ida_allins.PPC_xxspltiw
...
NEC850_ROUNDF_DL = _ida_allins.NEC850_ROUNDF_DL

NEC850_ROUNDF_DW = _ida_allins.NEC850_ROUNDF_DW

NEC850_ROUNDF_DUL = _ida_allins.NEC850_ROUNDF_DUL

NEC850_ROUNDF_DUW = _ida_allins.NEC850_ROUNDF_DUW

NEC850_ROUNDF_SL = _ida_allins.NEC850_ROUNDF_SL

NEC850_ROUNDF_SW = _ida_allins.NEC850_ROUNDF_SW

NEC850_ROUNDF_SUL = _ida_allins.NEC850_ROUNDF_SUL

NEC850_ROUNDF_SUW = _ida_allins.NEC850_ROUNDF_SUW

NEC850_LDM_MP = _ida_allins.NEC850_LDM_MP

NEC850_STM_MP = _ida_allins.NEC850_STM_MP

NEC850_CLIP_B = _ida_allins.NEC850_CLIP_B

NEC850_CLIP_BU = _ida_allins.NEC850_CLIP_BU

NEC850_CLIP_H = _ida_allins.NEC850_CLIP_H

NEC850_CLIP_HU = _ida_allins.NEC850_CLIP_HU

NEC850_LDL_BU = _ida_allins.NEC850_LDL_BU

NEC850_LDL_HU = _ida_allins.NEC850_LDL_HU

NEC850_RESBANK = _ida_allins.NEC850_RESBANK

NEC850_STC_B = _ida_allins.NEC850_STC_B

NEC850_STC_H = _ida_allins.NEC850_STC_H

NEC850_VAND = _ida_allins.NEC850_VAND

NEC850_VOR = _ida_allins.NEC850_VOR

NEC850_VXOR = _ida_allins.NEC850_VXOR

NEC850_VNOT = _ida_allins.NEC850_VNOT

NEC850_VSAR_H = _ida_allins.NEC850_VSAR_H

NEC850_VSAR_W = _ida_allins.NEC850_VSAR_W

NEC850_VSAR_DW = _ida_allins.NEC850_VSAR_DW

NEC850_VSHR_H = _ida_allins.NEC850_VSHR_H

NEC850_VSHR_W = _ida_allins.NEC850_VSHR_W

NEC850_VSHR_DW = _ida_allins.NEC850_VSHR_DW

NEC850_VSHL_H = _ida_allins.NEC850_VSHL_H

NEC850_VSHL_W = _ida_allins.NEC850_VSHL_W

NEC850_VSHL_DW = _ida_allins.NEC850_VSHL_DW

NEC850_VCONCAT_B = _ida_allins.NEC850_VCONCAT_B

NEC850_VITLV_H = _ida_allins.NEC850_VITLV_H

NEC850_VITLV_W = _ida_allins.NEC850_VITLV_W

NEC850_VITLVHW_H = _ida_allins.NEC850_VITLVHW_H

NEC850_VITLVWH_H = _ida_allins.NEC850_VITLVWH_H

NEC850_VSHUFL_B = _ida_allins.NEC850_VSHUFL_B

NEC850_VBSWAP_DW = _ida_allins.NEC850_VBSWAP_DW

NEC850_VBSWAP_H = _ida_allins.NEC850_VBSWAP_H

NEC850_VBSWAP_W = _ida_allins.NEC850_VBSWAP_W

NEC850_DUP_H = _ida_allins.NEC850_DUP_H

NEC850_DUP_W = _ida_allins.NEC850_DUP_W

NEC850_MOV_H = _ida_allins.NEC850_MOV_H

NEC850_MOV_W = _ida_allins.NEC850_MOV_W

NEC850_MOV_DW = _ida_allins.NEC850_MOV_DW

NEC850_VLD_B = _ida_allins.NEC850_VLD_B

NEC850_VLD_B_FMT3 = _ida_allins.NEC850_VLD_B_FMT3

NEC850_VLD_B_FMT4 = _ida_allins.NEC850_VLD_B_FMT4

NEC850_VLD_H = _ida_allins.NEC850_VLD_H

NEC850_VLD_H_FMT4 = _ida_allins.NEC850_VLD_H_FMT4

NEC850_VLD_W = _ida_allins.NEC850_VLD_W

NEC850_VLD_W_FMT4 = _ida_allins.NEC850_VLD_W_FMT4

NEC850_VLD_DW = _ida_allins.NEC850_VLD_DW

NEC850_VLD_DW_FMT3 = _ida_allins.NEC850_VLD_DW_FMT3

NEC850_VLD_DW_FMT4 = _ida_allins.NEC850_VLD_DW_FMT4

NEC850_VLD_DW_FMT5 = _ida_allins.NEC850_VLD_DW_FMT5

NEC850_VST_B = _ida_allins.NEC850_VST_B

NEC850_VST_B_FMT4 = _ida_allins.NEC850_VST_B_FMT4

NEC850_VST_H = _ida_allins.NEC850_VST_H

NEC850_VST_H_FMT_4_5 = _ida_allins.NEC850_VST_H_FMT_4_5

NEC850_VST_W = _ida_allins.NEC850_VST_W

NEC850_VST_W_FMT_4_5 = _ida_allins.NEC850_VST_W_FMT_4_5

NEC850_VST_DW = _ida_allins.NEC850_VST_DW

NEC850_VST_DW_FMT_4_5 = _ida_allins.NEC850_VST_DW_FMT_4_5

NEC850_VST_DW_FMT6 = _ida_allins.NEC850_VST_DW_FMT6

NEC850_VCMOV = _ida_allins.NEC850_VCMOV

NEC850_MODADD = _ida_allins.NEC850_MODADD

NEC850_VADD_H = _ida_allins.NEC850_VADD_H

NEC850_VADD_W = _ida_allins.NEC850_VADD_W

NEC850_VADD_DW = _ida_allins.NEC850_VADD_DW

NEC850_VSUB_H = _ida_allins.NEC850_VSUB_H

NEC850_VSUB_W = _ida_allins.NEC850_VSUB_W

NEC850_VSUB_DW = _ida_allins.NEC850_VSUB_DW

NEC850_VADDSAT_H = _ida_allins.NEC850_VADDSAT_H

NEC850_VADDSAT_W = _ida_allins.NEC850_VADDSAT_W

NEC850_VSUBSAT_H = _ida_allins.NEC850_VSUBSAT_H

NEC850_VSUBSAT_W = _ida_allins.NEC850_VSUBSAT_W

NEC850_VADDS_H = _ida_allins.NEC850_VADDS_H

NEC850_VADDS_W = _ida_allins.NEC850_VADDS_W

NEC850_VSUBS_H = _ida_allins.NEC850_VSUBS_H

NEC850_VSUBS_W = _ida_allins.NEC850_VSUBS_W

NEC850_VMUL_H = _ida_allins.NEC850_VMUL_H

NEC850_VMUL_W = _ida_allins.NEC850_VMUL_W

NEC850_VMULT_H = _ida_allins.NEC850_VMULT_H

NEC850_VMULT_W = _ida_allins.NEC850_VMULT_W

NEC850_VMULCX_H = _ida_allins.NEC850_VMULCX_H

NEC850_VMULCX_W = _ida_allins.NEC850_VMULCX_W

NEC850_VCMPEQ_H = _ida_allins.NEC850_VCMPEQ_H

NEC850_VCMPEQ_W = _ida_allins.NEC850_VCMPEQ_W

NEC850_VCMPLT_H = _ida_allins.NEC850_VCMPLT_H

NEC850_VCMPLT_W = _ida_allins.NEC850_VCMPLT_W

NEC850_VCMPLE_H = _ida_allins.NEC850_VCMPLE_H

NEC850_VCMPLE_W = _ida_allins.NEC850_VCMPLE_W

NEC850_VCMPNE_H = _ida_allins.NEC850_VCMPNE_H

NEC850_VCMPNE_W = _ida_allins.NEC850_VCMPNE_W

NEC850_VABS_H = _ida_allins.NEC850_VABS_H

NEC850_VABS_W = _ida_allins.NEC850_VABS_W

NEC850_VNEG_H = _ida_allins.NEC850_VNEG_H

NEC850_VNEG_W = _ida_allins.NEC850_VNEG_W

NEC850_VMAXGT_H = _ida_allins.NEC850_VMAXGT_H

NEC850_VMAXGE_H = _ida_allins.NEC850_VMAXGE_H

NEC850_VMINLT_H = _ida_allins.NEC850_VMINLT_H

NEC850_VMINLE_H = _ida_allins.NEC850_VMINLE_H

NEC850_VMAXGT_W = _ida_allins.NEC850_VMAXGT_W

NEC850_VMAXGE_W = _ida_allins.NEC850_VMAXGE_W

NEC850_VMINLT_W = _ida_allins.NEC850_VMINLT_W

NEC850_VMINLE_W = _ida_allins.NEC850_VMINLE_W

NEC850_VMADSAT_H = _ida_allins.NEC850_VMADSAT_H

NEC850_VMADSAT_W = _ida_allins.NEC850_VMADSAT_W

NEC850_VMADRN_H = _ida_allins.NEC850_VMADRN_H

NEC850_VMADRN_W = _ida_allins.NEC850_VMADRN_W

NEC850_VMSUM_H = _ida_allins.NEC850_VMSUM_H

NEC850_VMSUM_W = _ida_allins.NEC850_VMSUM_W

NEC850_VMSUMAD_H = _ida_allins.NEC850_VMSUMAD_H

NEC850_VMSUMAD_W = _ida_allins.NEC850_VMSUMAD_W

NEC850_VMSUMADRE_H = _ida_allins.NEC850_VMSUMADRE_H

NEC850_VMSUMADRE_W = _ida_allins.NEC850_VMSUMADRE_W

NEC850_VMSUMADIM_H = _ida_allins.NEC850_VMSUMADIM_H

NEC850_VMSUMADIM_W = _ida_allins.NEC850_VMSUMADIM_W

NEC850_VMSUMADRN_H = _ida_allins.NEC850_VMSUMADRN_H

NEC850_VBIQ_H = _ida_allins.NEC850_VBIQ_H

NEC850_PKUI8I16 = _ida_allins.NEC850_PKUI8I16

NEC850_PKI16I32 = _ida_allins.NEC850_PKI16I32

NEC850_PKQ15Q31 = _ida_allins.NEC850_PKQ15Q31

NEC850_PKI16UI8 = _ida_allins.NEC850_PKI16UI8

NEC850_PKI32I16 = _ida_allins.NEC850_PKI32I16

NEC850_PKQ31Q15 = _ida_allins.NEC850_PKQ31Q15

NEC850_PKQ30Q31 = _ida_allins.NEC850_PKQ30Q31

NEC850_PKI64I32 = _ida_allins.NEC850_PKI64I32

NEC850_CNVQ15Q30 = _ida_allins.NEC850_CNVQ15Q30

NEC850_CNVQ31Q62 = _ida_allins.NEC850_CNVQ31Q62

NEC850_CNVQ30Q15 = _ida_allins.NEC850_CNVQ30Q15

NEC850_CNVQ62Q31 = _ida_allins.NEC850_CNVQ62Q31

NEC850_EXPQ31 = _ida_allins.NEC850_EXPQ31

NEC850_VCALCH = _ida_allins.NEC850_VCALCH

NEC850_VCALCW = _ida_allins.NEC850_VCALCW

NEC850_MOVV_W4 = _ida_allins.NEC850_MOVV_W4

NEC850_FLPV_S4 = _ida_allins.NEC850_FLPV_S4

NEC850_SHFLV_W4 = _ida_allins.NEC850_SHFLV_W4

NEC850_LDV_DW = _ida_allins.NEC850_LDV_DW

NEC850_LDV_QW = _ida_allins.NEC850_LDV_QW

NEC850_LDV_W = _ida_allins.NEC850_LDV_W

NEC850_LDVZ_H4 = _ida_allins.NEC850_LDVZ_H4

NEC850_STV_DW = _ida_allins.NEC850_STV_DW

NEC850_STV_QW = _ida_allins.NEC850_STV_QW

NEC850_STV_W = _ida_allins.NEC850_STV_W

NEC850_STVZ_H4 = _ida_allins.NEC850_STVZ_H4

NEC850_CMOVF_W4 = _ida_allins.NEC850_CMOVF_W4

NEC850_TRFSRV_W4 = _ida_allins.NEC850_TRFSRV_W4

NEC850_ABSF_S4 = _ida_allins.NEC850_ABSF_S4

NEC850_ADDF_S4 = _ida_allins.NEC850_ADDF_S4

NEC850_DIVF_S4 = _ida_allins.NEC850_DIVF_S4

NEC850_MAXF_S4 = _ida_allins.NEC850_MAXF_S4

NEC850_MINF_S4 = _ida_allins.NEC850_MINF_S4

NEC850_MULF_S4 = _ida_allins.NEC850_MULF_S4

NEC850_NEGF_S4 = _ida_allins.NEC850_NEGF_S4

NEC850_RECIPF_S4 = _ida_allins.NEC850_RECIPF_S4

NEC850_RSQRTF_S4 = _ida_allins.NEC850_RSQRTF_S4

NEC850_SQRTF_S4 = _ida_allins.NEC850_SQRTF_S4

NEC850_SUBF_S4 = _ida_allins.NEC850_SUBF_S4

NEC850_FMAF_S4 = _ida_allins.NEC850_FMAF_S4

NEC850_FMSF_S4 = _ida_allins.NEC850_FMSF_S4

NEC850_FNMAF_S4 = _ida_allins.NEC850_FNMAF_S4

NEC850_FNMSF_S4 = _ida_allins.NEC850_FNMSF_S4

NEC850_ADDSUBF_S4 = _ida_allins.NEC850_ADDSUBF_S4

NEC850_ADDSUBNF_S4 = _ida_allins.NEC850_ADDSUBNF_S4

NEC850_SUBADDF_S4 = _ida_allins.NEC850_SUBADDF_S4

NEC850_SUBADDNF_S4 = _ida_allins.NEC850_SUBADDNF_S4

NEC850_ADDXF_S4 = _ida_allins.NEC850_ADDXF_S4

NEC850_MULXF_S4 = _ida_allins.NEC850_MULXF_S4

NEC850_SUBXF_S4 = _ida_allins.NEC850_SUBXF_S4

NEC850_ADDSUBNXF_S4 = _ida_allins.NEC850_ADDSUBNXF_S4

NEC850_ADDSUBXF_S4 = _ida_allins.NEC850_ADDSUBXF_S4

NEC850_SUBADDNXF_S4 = _ida_allins.NEC850_SUBADDNXF_S4

NEC850_SUBADDXF_S4 = _ida_allins.NEC850_SUBADDXF_S4

NEC850_ADDRF_S4 = _ida_allins.NEC850_ADDRF_S4

NEC850_MAXRF_S4 = _ida_allins.NEC850_MAXRF_S4

NEC850_MINRF_S4 = _ida_allins.NEC850_MINRF_S4

NEC850_MULRF_S4 = _ida_allins.NEC850_MULRF_S4

NEC850_SUBRF_S4 = _ida_allins.NEC850_SUBRF_S4

NEC850_CEILF_SUW4 = _ida_allins.NEC850_CEILF_SUW4

NEC850_CEILF_SW4 = _ida_allins.NEC850_CEILF_SW4

NEC850_CVTF_HS4 = _ida_allins.NEC850_CVTF_HS4

NEC850_CVTF_SH4 = _ida_allins.NEC850_CVTF_SH4

NEC850_CVTF_SUW4 = _ida_allins.NEC850_CVTF_SUW4

NEC850_CVTF_SW4 = _ida_allins.NEC850_CVTF_SW4

NEC850_CVTF_UWS4 = _ida_allins.NEC850_CVTF_UWS4

NEC850_CVTF_WS4 = _ida_allins.NEC850_CVTF_WS4

NEC850_FLOORF_SUW4 = _ida_allins.NEC850_FLOORF_SUW4

NEC850_FLOORF_SW4 = _ida_allins.NEC850_FLOORF_SW4

NEC850_ROUNDF_SUW4 = _ida_allins.NEC850_ROUNDF_SUW4

NEC850_ROUNDF_SW4 = _ida_allins.NEC850_ROUNDF_SW4

NEC850_TRNCF_SUW4 = _ida_allins.NEC850_TRNCF_SUW4

NEC850_TRNCF_SW4 = _ida_allins.NEC850_TRNCF_SW4

NEC850_CMPF_S4 = _ida_allins.NEC850_CMPF_S4
...
TRICORE_not16 = _ida_allins.TRICORE_not16
...
TRICORE_ftohp = _ida_allins.TRICORE_ftohp

TRICORE_hptof = _ida_allins.TRICORE_hptof
...
TMS28_absf32 = _ida_allins.TMS28_absf32

TMS28_addf32 = _ida_allins.TMS28_addf32

TMS28_cmpf32 = _ida_allins.TMS28_cmpf32

TMS28_einvf32 = _ida_allins.TMS28_einvf32

TMS28_eisqrtf32 = _ida_allins.TMS28_eisqrtf32

TMS28_f32toi16 = _ida_allins.TMS28_f32toi16

TMS28_f32toi16r = _ida_allins.TMS28_f32toi16r

TMS28_f32toi32 = _ida_allins.TMS28_f32toi32

TMS28_f32toui16 = _ida_allins.TMS28_f32toui16

TMS28_f32toui16r = _ida_allins.TMS28_f32toui16r

TMS28_f32toui32 = _ida_allins.TMS28_f32toui32

TMS28_fracf32 = _ida_allins.TMS28_fracf32

TMS28_i16tof32 = _ida_allins.TMS28_i16tof32

TMS28_i32tof32 = _ida_allins.TMS28_i32tof32

TMS28_macf32 = _ida_allins.TMS28_macf32

TMS28_maxf32 = _ida_allins.TMS28_maxf32

TMS28_minf32 = _ida_allins.TMS28_minf32

TMS28_mov16 = _ida_allins.TMS28_mov16

TMS28_mov32 = _ida_allins.TMS28_mov32

TMS28_movd32 = _ida_allins.TMS28_movd32

TMS28_movf32 = _ida_allins.TMS28_movf32

TMS28_moviz = _ida_allins.TMS28_moviz

TMS28_movst0 = _ida_allins.TMS28_movst0

TMS28_movxi = _ida_allins.TMS28_movxi

TMS28_mpyf32 = _ida_allins.TMS28_mpyf32

TMS28_negf32 = _ida_allins.TMS28_negf32

TMS28_poprb = _ida_allins.TMS28_poprb

TMS28_pushrb = _ida_allins.TMS28_pushrb

TMS28_restore = _ida_allins.TMS28_restore

TMS28_rptb = _ida_allins.TMS28_rptb

TMS28_save = _ida_allins.TMS28_save

TMS28_setflg = _ida_allins.TMS28_setflg

TMS28_subf32 = _ida_allins.TMS28_subf32

TMS28_swapf = _ida_allins.TMS28_swapf

TMS28_testtf = _ida_allins.TMS28_testtf

TMS28_ui16tof32 = _ida_allins.TMS28_ui16tof32

TMS28_ui32tof32 = _ida_allins.TMS28_ui32tof32

TMS28_zero = _ida_allins.TMS28_zero

TMS28_zeroa = _ida_allins.TMS28_zeroa

TMS28_movdd32 = _ida_allins.TMS28_movdd32

TMS28_movix = _ida_allins.TMS28_movix

TMS28_macf64 = _ida_allins.TMS28_macf64

TMS28_mpyf64 = _ida_allins.TMS28_mpyf64

TMS28_addf64 = _ida_allins.TMS28_addf64

TMS28_subf64 = _ida_allins.TMS28_subf64

TMS28_cmpf64 = _ida_allins.TMS28_cmpf64

TMS28_maxf64 = _ida_allins.TMS28_maxf64

TMS28_minf64 = _ida_allins.TMS28_minf64

TMS28_f64toi32 = _ida_allins.TMS28_f64toi32

TMS28_f64toui32 = _ida_allins.TMS28_f64toui32

TMS28_i32tof64 = _ida_allins.TMS28_i32tof64

TMS28_ui32tof64 = _ida_allins.TMS28_ui32tof64

TMS28_f64toi64 = _ida_allins.TMS28_f64toi64

TMS28_f64toui64 = _ida_allins.TMS28_f64toui64

TMS28_i64tof64 = _ida_allins.TMS28_i64tof64

TMS28_ui64tof64 = _ida_allins.TMS28_ui64tof64

TMS28_fracf64 = _ida_allins.TMS28_fracf64

TMS28_f64tof32 = _ida_allins.TMS28_f64tof32

TMS28_f32tof64 = _ida_allins.TMS28_f32tof64

TMS28_f32dtof64 = _ida_allins.TMS28_f32dtof64

TMS28_absf64 = _ida_allins.TMS28_absf64

TMS28_negf64 = _ida_allins.TMS28_negf64

TMS28_mov64 = _ida_allins.TMS28_mov64

TMS28_eisqrtf64 = _ida_allins.TMS28_eisqrtf64

TMS28_einvf64 = _ida_allins.TMS28_einvf64

TMS28_vclear = _ida_allins.TMS28_vclear

TMS28_vclearall = _ida_allins.TMS28_vclearall

TMS28_vclrovfi = _ida_allins.TMS28_vclrovfi

TMS28_vclrovfr = _ida_allins.TMS28_vclrovfr

TMS28_vmov16 = _ida_allins.TMS28_vmov16

TMS28_vmov32 = _ida_allins.TMS28_vmov32

TMS28_vmovd32 = _ida_allins.TMS28_vmovd32

TMS28_vmovix = _ida_allins.TMS28_vmovix

TMS28_vmovzi = _ida_allins.TMS28_vmovzi

TMS28_vmovxi = _ida_allins.TMS28_vmovxi

TMS28_vrndoff = _ida_allins.TMS28_vrndoff

TMS28_vrndon = _ida_allins.TMS28_vrndon

TMS28_vsatoff = _ida_allins.TMS28_vsatoff

TMS28_vsaton = _ida_allins.TMS28_vsaton

TMS28_vsetshl = _ida_allins.TMS28_vsetshl

TMS28_vsetshr = _ida_allins.TMS28_vsetshr

TMS28_vcadd = _ida_allins.TMS28_vcadd

TMS28_vcdadd16 = _ida_allins.TMS28_vcdadd16

TMS28_vcdsub16 = _ida_allins.TMS28_vcdsub16

TMS28_vcmac = _ida_allins.TMS28_vcmac

TMS28_vcmpy = _ida_allins.TMS28_vcmpy

TMS28_vneg = _ida_allins.TMS28_vneg

TMS28_vcsub = _ida_allins.TMS28_vcsub

TMS28_vcrc8h_1 = _ida_allins.TMS28_vcrc8h_1

TMS28_vcrc8l_1 = _ida_allins.TMS28_vcrc8l_1

TMS28_vcrc16p1h_1 = _ida_allins.TMS28_vcrc16p1h_1

TMS28_vcrc16p1l_1 = _ida_allins.TMS28_vcrc16p1l_1

TMS28_vcrc16p2h_1 = _ida_allins.TMS28_vcrc16p2h_1

TMS28_vcrc16p2l_1 = _ida_allins.TMS28_vcrc16p2l_1

TMS28_vcrc32h_1 = _ida_allins.TMS28_vcrc32h_1

TMS28_vcrc32l_1 = _ida_allins.TMS28_vcrc32l_1

TMS28_vcrcclr = _ida_allins.TMS28_vcrcclr

TMS28_vitbm2 = _ida_allins.TMS28_vitbm2

TMS28_vitbm3 = _ida_allins.TMS28_vitbm3

TMS28_vitdhaddsub = _ida_allins.TMS28_vitdhaddsub

TMS28_vitdhsubadd = _ida_allins.TMS28_vitdhsubadd

TMS28_vitdladdsub = _ida_allins.TMS28_vitdladdsub

TMS28_vitdlsubadd = _ida_allins.TMS28_vitdlsubadd

TMS28_vithsel = _ida_allins.TMS28_vithsel

TMS28_vitlsel = _ida_allins.TMS28_vitlsel

TMS28_vtclear = _ida_allins.TMS28_vtclear

TMS28_vtrace = _ida_allins.TMS28_vtrace

TMS28_vnop = _ida_allins.TMS28_vnop

TMS28_vsetcrcmsgflip = _ida_allins.TMS28_vsetcrcmsgflip

TMS28_vclrcrcmsgflip = _ida_allins.TMS28_vclrcrcmsgflip

TMS28_vcrc32p2l_1 = _ida_allins.TMS28_vcrc32p2l_1

TMS28_vcrc32p2h_1 = _ida_allins.TMS28_vcrc32p2h_1

TMS28_vcrc24l_1 = _ida_allins.TMS28_vcrc24l_1

TMS28_vcrc24h_1 = _ida_allins.TMS28_vcrc24h_1

TMS28_vsetcrcsize = _ida_allins.TMS28_vsetcrcsize

TMS28_vcrcl = _ida_allins.TMS28_vcrcl

TMS28_vcrch = _ida_allins.TMS28_vcrch

TMS28_vswapcrc = _ida_allins.TMS28_vswapcrc

TMS28_vclrcpack = _ida_allins.TMS28_vclrcpack

TMS28_vclropack = _ida_allins.TMS28_vclropack

TMS28_vsetcpack = _ida_allins.TMS28_vsetcpack

TMS28_vsetopack = _ida_allins.TMS28_vsetopack

TMS28_vswap32 = _ida_allins.TMS28_vswap32

TMS28_vxormov32 = _ida_allins.TMS28_vxormov32

TMS28_vashl32 = _ida_allins.TMS28_vashl32

TMS28_vashr32 = _ida_allins.TMS28_vashr32

TMS28_vbitflip = _ida_allins.TMS28_vbitflip

TMS28_vlshl32 = _ida_allins.TMS28_vlshl32

TMS28_vlshr32 = _ida_allins.TMS28_vlshr32

TMS28_vccmac = _ida_allins.TMS28_vccmac

TMS28_vccmpy = _ida_allins.TMS28_vccmpy

TMS28_vccon = _ida_allins.TMS28_vccon

TMS28_vcflip = _ida_allins.TMS28_vcflip

TMS28_vcmag = _ida_allins.TMS28_vcmag

TMS28_vcshl16 = _ida_allins.TMS28_vcshl16

TMS28_vcshr16 = _ida_allins.TMS28_vcshr16

TMS28_vclrdive = _ida_allins.TMS28_vclrdive

TMS28_vdec = _ida_allins.TMS28_vdec

TMS28_vinc = _ida_allins.TMS28_vinc

TMS28_vmod32 = _ida_allins.TMS28_vmod32

TMS28_vmpyadd = _ida_allins.TMS28_vmpyadd

TMS28_vcfft1 = _ida_allins.TMS28_vcfft1

TMS28_vcfft2 = _ida_allins.TMS28_vcfft2

TMS28_vcfft3 = _ida_allins.TMS28_vcfft3

TMS28_vcfft4 = _ida_allins.TMS28_vcfft4

TMS28_vcfft5 = _ida_allins.TMS28_vcfft5

TMS28_vcfft6 = _ida_allins.TMS28_vcfft6

TMS28_vcfft7 = _ida_allins.TMS28_vcfft7

TMS28_vcfft8 = _ida_allins.TMS28_vcfft8

TMS28_vcfft9 = _ida_allins.TMS28_vcfft9

TMS28_vcfft10 = _ida_allins.TMS28_vcfft10

TMS28_vgfacc = _ida_allins.TMS28_vgfacc

TMS28_vgfadd4 = _ida_allins.TMS28_vgfadd4

TMS28_vgfinit = _ida_allins.TMS28_vgfinit

TMS28_vgfmac4 = _ida_allins.TMS28_vgfmac4

TMS28_vgfmpy4 = _ida_allins.TMS28_vgfmpy4

TMS28_vpack4 = _ida_allins.TMS28_vpack4

TMS28_vrevb = _ida_allins.TMS28_vrevb

TMS28_vshlmb = _ida_allins.TMS28_vshlmb

TMS28_vitstage = _ida_allins.TMS28_vitstage

TMS28_vsetk = _ida_allins.TMS28_vsetk

TMS28_vsminit = _ida_allins.TMS28_vsminit

TMS28_absi32div32 = _ida_allins.TMS28_absi32div32

TMS28_absi32div32u = _ida_allins.TMS28_absi32div32u

TMS28_absi64div32 = _ida_allins.TMS28_absi64div32

TMS28_absi64div32u = _ida_allins.TMS28_absi64div32u

TMS28_absi64div64 = _ida_allins.TMS28_absi64div64

TMS28_absi64div64u = _ida_allins.TMS28_absi64div64u

TMS28_subc4ui32 = _ida_allins.TMS28_subc4ui32

TMS28_subc2ui64 = _ida_allins.TMS28_subc2ui64

TMS28_negi32div32 = _ida_allins.TMS28_negi32div32

TMS28_enegi32div32 = _ida_allins.TMS28_enegi32div32

TMS28_mnegi32div32 = _ida_allins.TMS28_mnegi32div32

TMS28_negi64div32 = _ida_allins.TMS28_negi64div32

TMS28_enegi64div32 = _ida_allins.TMS28_enegi64div32

TMS28_mnegi64div32 = _ida_allins.TMS28_mnegi64div32

TMS28_negi64div64 = _ida_allins.TMS28_negi64div64

TMS28_enegi64div64 = _ida_allins.TMS28_enegi64div64

TMS28_mnegi64div64 = _ida_allins.TMS28_mnegi64div64

TMS28_mpy2pif32 = _ida_allins.TMS28_mpy2pif32

TMS28_div2pif32 = _ida_allins.TMS28_div2pif32

TMS28_divf32 = _ida_allins.TMS28_divf32

TMS28_sqrtf32 = _ida_allins.TMS28_sqrtf32

TMS28_sinpuf32 = _ida_allins.TMS28_sinpuf32

TMS28_cospuf32 = _ida_allins.TMS28_cospuf32

TMS28_atanpuf32 = _ida_allins.TMS28_atanpuf32

TMS28_quadf32 = _ida_allins.TMS28_quadf32

TMS28_iexp2f32 = _ida_allins.TMS28_iexp2f32

TMS28_log2f32 = _ida_allins.TMS28_log2f32
...
DALVIK_CONST_METHOD_HANDLE = _ida_allins.DALVIK_CONST_METHOD_HANDLE

DALVIK_CONST_METHOD_TYPE = _ida_allins.DALVIK_CONST_METHOD_TYPE
...
RISCV_vsetvl = _ida_allins.RISCV_vsetvl

RISCV_vsetvli = _ida_allins.RISCV_vsetvli

RISCV_vsetivli = _ida_allins.RISCV_vsetivli

RISCV_vl = _ida_allins.RISCV_vl

RISCV_vs = _ida_allins.RISCV_vs

RISCV_vadd = _ida_allins.RISCV_vadd

RISCV_vsub = _ida_allins.RISCV_vsub

RISCV_vrsub = _ida_allins.RISCV_vrsub

RISCV_vminu = _ida_allins.RISCV_vminu

RISCV_vmin = _ida_allins.RISCV_vmin

RISCV_vmaxu = _ida_allins.RISCV_vmaxu

RISCV_vmax = _ida_allins.RISCV_vmax

RISCV_vand = _ida_allins.RISCV_vand

RISCV_vor = _ida_allins.RISCV_vor

RISCV_vxor = _ida_allins.RISCV_vxor

RISCV_vrgather = _ida_allins.RISCV_vrgather

RISCV_vslideup = _ida_allins.RISCV_vslideup

RISCV_vrgatherei16 = _ida_allins.RISCV_vrgatherei16

RISCV_vslidedown = _ida_allins.RISCV_vslidedown

RISCV_vadc = _ida_allins.RISCV_vadc

RISCV_vmadc = _ida_allins.RISCV_vmadc

RISCV_vsbc = _ida_allins.RISCV_vsbc

RISCV_vmsbc = _ida_allins.RISCV_vmsbc

RISCV_vmerge = _ida_allins.RISCV_vmerge

RISCV_vmv = _ida_allins.RISCV_vmv

RISCV_vmseq = _ida_allins.RISCV_vmseq

RISCV_vmsne = _ida_allins.RISCV_vmsne

RISCV_vmsltu = _ida_allins.RISCV_vmsltu

RISCV_vmslt = _ida_allins.RISCV_vmslt

RISCV_vmsleu = _ida_allins.RISCV_vmsleu

RISCV_vmsle = _ida_allins.RISCV_vmsle

RISCV_vmsgtu = _ida_allins.RISCV_vmsgtu

RISCV_vmsgt = _ida_allins.RISCV_vmsgt

RISCV_vsaddu = _ida_allins.RISCV_vsaddu

RISCV_vsadd = _ida_allins.RISCV_vsadd

RISCV_vssubu = _ida_allins.RISCV_vssubu

RISCV_vssub = _ida_allins.RISCV_vssub

RISCV_vsll = _ida_allins.RISCV_vsll

RISCV_vsmul = _ida_allins.RISCV_vsmul

RISCV_vmvr = _ida_allins.RISCV_vmvr

RISCV_vsrl = _ida_allins.RISCV_vsrl

RISCV_vsra = _ida_allins.RISCV_vsra

RISCV_vssrl = _ida_allins.RISCV_vssrl

RISCV_vssra = _ida_allins.RISCV_vssra

RISCV_vnsrl = _ida_allins.RISCV_vnsrl

RISCV_vnsra = _ida_allins.RISCV_vnsra

RISCV_vnclipu = _ida_allins.RISCV_vnclipu

RISCV_vnclip = _ida_allins.RISCV_vnclip

RISCV_vwredsumu = _ida_allins.RISCV_vwredsumu

RISCV_vwredsum = _ida_allins.RISCV_vwredsum

RISCV_vredsum = _ida_allins.RISCV_vredsum

RISCV_vredand = _ida_allins.RISCV_vredand

RISCV_vredor = _ida_allins.RISCV_vredor

RISCV_vredxor = _ida_allins.RISCV_vredxor

RISCV_vredminu = _ida_allins.RISCV_vredminu

RISCV_vredmin = _ida_allins.RISCV_vredmin

RISCV_vredmaxu = _ida_allins.RISCV_vredmaxu

RISCV_vredmax = _ida_allins.RISCV_vredmax

RISCV_vaaddu = _ida_allins.RISCV_vaaddu

RISCV_vaadd = _ida_allins.RISCV_vaadd

RISCV_vasubu = _ida_allins.RISCV_vasubu

RISCV_vasub = _ida_allins.RISCV_vasub

RISCV_vslide1up = _ida_allins.RISCV_vslide1up

RISCV_vslide1down = _ida_allins.RISCV_vslide1down

RISCV_vcpop = _ida_allins.RISCV_vcpop

RISCV_vfirst = _ida_allins.RISCV_vfirst

RISCV_vmvi = _ida_allins.RISCV_vmvi

RISCV_vzext = _ida_allins.RISCV_vzext

RISCV_vsext = _ida_allins.RISCV_vsext

RISCV_vmsbf = _ida_allins.RISCV_vmsbf

RISCV_vmsof = _ida_allins.RISCV_vmsof

RISCV_vmsif = _ida_allins.RISCV_vmsif

RISCV_viota = _ida_allins.RISCV_viota

RISCV_vid = _ida_allins.RISCV_vid

RISCV_vcompress = _ida_allins.RISCV_vcompress

RISCV_vmandn = _ida_allins.RISCV_vmandn

RISCV_vmand = _ida_allins.RISCV_vmand

RISCV_vmor = _ida_allins.RISCV_vmor

RISCV_vmxor = _ida_allins.RISCV_vmxor

RISCV_vmorn = _ida_allins.RISCV_vmorn

RISCV_vmnand = _ida_allins.RISCV_vmnand

RISCV_vmnor = _ida_allins.RISCV_vmnor

RISCV_vmxnor = _ida_allins.RISCV_vmxnor

RISCV_vdivu = _ida_allins.RISCV_vdivu

RISCV_vdiv = _ida_allins.RISCV_vdiv

RISCV_vremu = _ida_allins.RISCV_vremu

RISCV_vrem = _ida_allins.RISCV_vrem

RISCV_vmulhu = _ida_allins.RISCV_vmulhu

RISCV_vmul = _ida_allins.RISCV_vmul

RISCV_vmulhsu = _ida_allins.RISCV_vmulhsu

RISCV_vmulh = _ida_allins.RISCV_vmulh

RISCV_vmadd = _ida_allins.RISCV_vmadd

RISCV_vnmsub = _ida_allins.RISCV_vnmsub

RISCV_vmacc = _ida_allins.RISCV_vmacc

RISCV_vnmsac = _ida_allins.RISCV_vnmsac

RISCV_vwaddu = _ida_allins.RISCV_vwaddu

RISCV_vwadd = _ida_allins.RISCV_vwadd

RISCV_vwsubu = _ida_allins.RISCV_vwsubu

RISCV_vwsub = _ida_allins.RISCV_vwsub

RISCV_vwadduw = _ida_allins.RISCV_vwadduw

RISCV_vwaddw = _ida_allins.RISCV_vwaddw

RISCV_vwsubuw = _ida_allins.RISCV_vwsubuw

RISCV_vwsubw = _ida_allins.RISCV_vwsubw

RISCV_vwmulu = _ida_allins.RISCV_vwmulu

RISCV_vwmulsu = _ida_allins.RISCV_vwmulsu

RISCV_vwmul = _ida_allins.RISCV_vwmul

RISCV_vwmaccu = _ida_allins.RISCV_vwmaccu

RISCV_vwmacc = _ida_allins.RISCV_vwmacc

RISCV_vwmaccus = _ida_allins.RISCV_vwmaccus

RISCV_vwmaccsu = _ida_allins.RISCV_vwmaccsu

RISCV_vfadd = _ida_allins.RISCV_vfadd

RISCV_vfredusum = _ida_allins.RISCV_vfredusum

RISCV_vfsub = _ida_allins.RISCV_vfsub

RISCV_vfredosum = _ida_allins.RISCV_vfredosum

RISCV_vfmin = _ida_allins.RISCV_vfmin

RISCV_vfredmin = _ida_allins.RISCV_vfredmin

RISCV_vfmax = _ida_allins.RISCV_vfmax

RISCV_vfredmax = _ida_allins.RISCV_vfredmax

RISCV_vfsgnj = _ida_allins.RISCV_vfsgnj

RISCV_vfsgnjn = _ida_allins.RISCV_vfsgnjn

RISCV_vfsgnjx = _ida_allins.RISCV_vfsgnjx

RISCV_vfslide1up = _ida_allins.RISCV_vfslide1up

RISCV_vfslide1down = _ida_allins.RISCV_vfslide1down

RISCV_vfmov = _ida_allins.RISCV_vfmov

RISCV_vfcvt = _ida_allins.RISCV_vfcvt

RISCV_vfwcvt = _ida_allins.RISCV_vfwcvt

RISCV_vfncvt = _ida_allins.RISCV_vfncvt

RISCV_vfsqrt = _ida_allins.RISCV_vfsqrt

RISCV_vfrsqrt7 = _ida_allins.RISCV_vfrsqrt7

RISCV_vfrec7 = _ida_allins.RISCV_vfrec7

RISCV_vfclass = _ida_allins.RISCV_vfclass

RISCV_vfmerge = _ida_allins.RISCV_vfmerge

RISCV_vfmv = _ida_allins.RISCV_vfmv

RISCV_vmfeq = _ida_allins.RISCV_vmfeq

RISCV_vmfle = _ida_allins.RISCV_vmfle

RISCV_vmflt = _ida_allins.RISCV_vmflt

RISCV_vmfne = _ida_allins.RISCV_vmfne

RISCV_vmfgt = _ida_allins.RISCV_vmfgt

RISCV_vmfge = _ida_allins.RISCV_vmfge

RISCV_vfdiv = _ida_allins.RISCV_vfdiv

RISCV_vfrdiv = _ida_allins.RISCV_vfrdiv

RISCV_vfmul = _ida_allins.RISCV_vfmul

RISCV_vfrsub = _ida_allins.RISCV_vfrsub

RISCV_vfmadd = _ida_allins.RISCV_vfmadd

RISCV_vfnmadd = _ida_allins.RISCV_vfnmadd

RISCV_vfmsub = _ida_allins.RISCV_vfmsub

RISCV_vfnmsub = _ida_allins.RISCV_vfnmsub

RISCV_vfmacc = _ida_allins.RISCV_vfmacc

RISCV_vfnmacc = _ida_allins.RISCV_vfnmacc

RISCV_vfmsac = _ida_allins.RISCV_vfmsac

RISCV_vfnmsac = _ida_allins.RISCV_vfnmsac

RISCV_vfwadd = _ida_allins.RISCV_vfwadd

RISCV_vfwredusum = _ida_allins.RISCV_vfwredusum

RISCV_vfwsub = _ida_allins.RISCV_vfwsub

RISCV_vfwredosum = _ida_allins.RISCV_vfwredosum

RISCV_vfwaddw = _ida_allins.RISCV_vfwaddw

RISCV_vfwsubw = _ida_allins.RISCV_vfwsubw

RISCV_vfwmul = _ida_allins.RISCV_vfwmul

RISCV_vfwmacc = _ida_allins.RISCV_vfwmacc

RISCV_vfwnmacc = _ida_allins.RISCV_vfwnmacc

RISCV_vfwmsac = _ida_allins.RISCV_vfwmsac

RISCV_vfwnmsac = _ida_allins.RISCV_vfwnmsac

RISCV_vneg = _ida_allins.RISCV_vneg

RISCV_vwcvt = _ida_allins.RISCV_vwcvt

RISCV_vwcvtu = _ida_allins.RISCV_vwcvtu

RISCV_vnot = _ida_allins.RISCV_vnot

RISCV_vncvt = _ida_allins.RISCV_vncvt

RISCV_vfneg = _ida_allins.RISCV_vfneg

RISCV_vfabs = _ida_allins.RISCV_vfabs

RISCV_vmmv = _ida_allins.RISCV_vmmv

RISCV_vmclr = _ida_allins.RISCV_vmclr

RISCV_vmset = _ida_allins.RISCV_vmset

RISCV_vmnot = _ida_allins.RISCV_vmnot

RISCV_andn = _ida_allins.RISCV_andn

RISCV_bclr = _ida_allins.RISCV_bclr

RISCV_bclri = _ida_allins.RISCV_bclri

RISCV_bext = _ida_allins.RISCV_bext

RISCV_bexti = _ida_allins.RISCV_bexti

RISCV_binv = _ida_allins.RISCV_binv

RISCV_binvi = _ida_allins.RISCV_binvi

RISCV_bset = _ida_allins.RISCV_bset

RISCV_bseti = _ida_allins.RISCV_bseti

RISCV_clmul = _ida_allins.RISCV_clmul

RISCV_clmulh = _ida_allins.RISCV_clmulh

RISCV_clmulr = _ida_allins.RISCV_clmulr

RISCV_clz = _ida_allins.RISCV_clz

RISCV_clzw = _ida_allins.RISCV_clzw

RISCV_cpop = _ida_allins.RISCV_cpop

RISCV_cpopw = _ida_allins.RISCV_cpopw

RISCV_ctz = _ida_allins.RISCV_ctz

RISCV_ctzw = _ida_allins.RISCV_ctzw

RISCV_max = _ida_allins.RISCV_max

RISCV_maxu = _ida_allins.RISCV_maxu

RISCV_min = _ida_allins.RISCV_min

RISCV_minu = _ida_allins.RISCV_minu

RISCV_orc = _ida_allins.RISCV_orc

RISCV_orn = _ida_allins.RISCV_orn

RISCV_rev8 = _ida_allins.RISCV_rev8

RISCV_rol = _ida_allins.RISCV_rol

RISCV_rolw = _ida_allins.RISCV_rolw

RISCV_ror = _ida_allins.RISCV_ror

RISCV_rori = _ida_allins.RISCV_rori

RISCV_roriw = _ida_allins.RISCV_roriw

RISCV_rorw = _ida_allins.RISCV_rorw

RISCV_sh1add = _ida_allins.RISCV_sh1add

RISCV_sh2add = _ida_allins.RISCV_sh2add

RISCV_sh3add = _ida_allins.RISCV_sh3add

RISCV_xnor = _ida_allins.RISCV_xnor

RISCV_zext = _ida_allins.RISCV_zext

RISCV_flh = _ida_allins.RISCV_flh

RISCV_fsh = _ida_allins.RISCV_fsh

RISCV_hl = _ida_allins.RISCV_hl

RISCV_hs = _ida_allins.RISCV_hs

RISCV_sinval = _ida_allins.RISCV_sinval

RISCV_sfencefg = _ida_allins.RISCV_sfencefg

RISCV_hinval = _ida_allins.RISCV_hinval

RISCV_pause = _ida_allins.RISCV_pause

RISCV_cbo = _ida_allins.RISCV_cbo

RISCV_prefetch = _ida_allins.RISCV_prefetch

RISCV_sfencevm = _ida_allins.RISCV_sfencevm

RISCV_aes = _ida_allins.RISCV_aes

RISCV_aes64im = _ida_allins.RISCV_aes64im

RISCV_aes64ks1i = _ida_allins.RISCV_aes64ks1i

RISCV_aes64ks2 = _ida_allins.RISCV_aes64ks2

RISCV_brev8 = _ida_allins.RISCV_brev8

RISCV_pack = _ida_allins.RISCV_pack

RISCV_packh = _ida_allins.RISCV_packh

RISCV_packw = _ida_allins.RISCV_packw

RISCV_sha256 = _ida_allins.RISCV_sha256

RISCV_sha512 = _ida_allins.RISCV_sha512

RISCV_sm3 = _ida_allins.RISCV_sm3

RISCV_sm4 = _ida_allins.RISCV_sm4

RISCV_unzip = _ida_allins.RISCV_unzip

RISCV_xperm4 = _ida_allins.RISCV_xperm4

RISCV_xperm8 = _ida_allins.RISCV_xperm8

RISCV_zip = _ida_allins.RISCV_zip

RISCV_wrsnto = _ida_allins.RISCV_wrsnto

RISCV_wrssto = _ida_allins.RISCV_wrssto

RISCV_thdcachecall = _ida_allins.RISCV_thdcachecall

RISCV_thdcacheciall = _ida_allins.RISCV_thdcacheciall

RISCV_thdcacheiall = _ida_allins.RISCV_thdcacheiall

RISCV_thdcachecpa = _ida_allins.RISCV_thdcachecpa

RISCV_thdcachecipa = _ida_allins.RISCV_thdcachecipa

RISCV_thdcacheipa = _ida_allins.RISCV_thdcacheipa

RISCV_thdcachecva = _ida_allins.RISCV_thdcachecva

RISCV_thdcacheciva = _ida_allins.RISCV_thdcacheciva

RISCV_thdcacheiva = _ida_allins.RISCV_thdcacheiva

RISCV_thdcachecsw = _ida_allins.RISCV_thdcachecsw

RISCV_thdcachecisw = _ida_allins.RISCV_thdcachecisw

RISCV_thdcacheisw = _ida_allins.RISCV_thdcacheisw

RISCV_thdcachecpal1 = _ida_allins.RISCV_thdcachecpal1

RISCV_thdcachecval1 = _ida_allins.RISCV_thdcachecval1

RISCV_thicacheiall = _ida_allins.RISCV_thicacheiall

RISCV_thicacheialls = _ida_allins.RISCV_thicacheialls

RISCV_thicacheipa = _ida_allins.RISCV_thicacheipa

RISCV_thicacheiva = _ida_allins.RISCV_thicacheiva

RISCV_thl2cachecall = _ida_allins.RISCV_thl2cachecall

RISCV_thl2cacheciall = _ida_allins.RISCV_thl2cacheciall

RISCV_thl2cacheiall = _ida_allins.RISCV_thl2cacheiall

RISCV_thsfencevmas = _ida_allins.RISCV_thsfencevmas

RISCV_thsync = _ida_allins.RISCV_thsync

RISCV_thsyncs = _ida_allins.RISCV_thsyncs

RISCV_thsynci = _ida_allins.RISCV_thsynci

RISCV_thsyncis = _ida_allins.RISCV_thsyncis

RISCV_thaddsl = _ida_allins.RISCV_thaddsl

RISCV_thsrri = _ida_allins.RISCV_thsrri

RISCV_thsrriw = _ida_allins.RISCV_thsrriw

RISCV_thext = _ida_allins.RISCV_thext

RISCV_thextu = _ida_allins.RISCV_thextu

RISCV_thff0 = _ida_allins.RISCV_thff0

RISCV_thff1 = _ida_allins.RISCV_thff1

RISCV_threv = _ida_allins.RISCV_threv

RISCV_threvw = _ida_allins.RISCV_threvw

RISCV_thtstnbz = _ida_allins.RISCV_thtstnbz

RISCV_thtst = _ida_allins.RISCV_thtst

RISCV_thmveqz = _ida_allins.RISCV_thmveqz

RISCV_thmvnez = _ida_allins.RISCV_thmvnez

RISCV_thlbia = _ida_allins.RISCV_thlbia

RISCV_thlbib = _ida_allins.RISCV_thlbib

RISCV_thlbuia = _ida_allins.RISCV_thlbuia

RISCV_thlbuib = _ida_allins.RISCV_thlbuib

RISCV_thlhia = _ida_allins.RISCV_thlhia

RISCV_thlhib = _ida_allins.RISCV_thlhib

RISCV_thlhuia = _ida_allins.RISCV_thlhuia

RISCV_thlhuib = _ida_allins.RISCV_thlhuib

RISCV_thlwia = _ida_allins.RISCV_thlwia

RISCV_thlwib = _ida_allins.RISCV_thlwib

RISCV_thlwuia = _ida_allins.RISCV_thlwuia

RISCV_thlwuib = _ida_allins.RISCV_thlwuib

RISCV_thldia = _ida_allins.RISCV_thldia

RISCV_thldib = _ida_allins.RISCV_thldib

RISCV_thsbia = _ida_allins.RISCV_thsbia

RISCV_thsbib = _ida_allins.RISCV_thsbib

RISCV_thshia = _ida_allins.RISCV_thshia

RISCV_thshib = _ida_allins.RISCV_thshib

RISCV_thswia = _ida_allins.RISCV_thswia

RISCV_thswib = _ida_allins.RISCV_thswib

RISCV_thsdia = _ida_allins.RISCV_thsdia

RISCV_thsdib = _ida_allins.RISCV_thsdib

RISCV_thlrb = _ida_allins.RISCV_thlrb

RISCV_thlrbu = _ida_allins.RISCV_thlrbu

RISCV_thlrh = _ida_allins.RISCV_thlrh

RISCV_thlrhu = _ida_allins.RISCV_thlrhu

RISCV_thlrw = _ida_allins.RISCV_thlrw

RISCV_thlrwu = _ida_allins.RISCV_thlrwu

RISCV_thlrd = _ida_allins.RISCV_thlrd

RISCV_thsrb = _ida_allins.RISCV_thsrb

RISCV_thsrh = _ida_allins.RISCV_thsrh

RISCV_thsrw = _ida_allins.RISCV_thsrw

RISCV_thsrd = _ida_allins.RISCV_thsrd

RISCV_thlurb = _ida_allins.RISCV_thlurb

RISCV_thlurbu = _ida_allins.RISCV_thlurbu

RISCV_thlurh = _ida_allins.RISCV_thlurh

RISCV_thlurhu = _ida_allins.RISCV_thlurhu

RISCV_thlurw = _ida_allins.RISCV_thlurw

RISCV_thlurwu = _ida_allins.RISCV_thlurwu

RISCV_thlurd = _ida_allins.RISCV_thlurd

RISCV_thsurb = _ida_allins.RISCV_thsurb

RISCV_thsurh = _ida_allins.RISCV_thsurh

RISCV_thsurw = _ida_allins.RISCV_thsurw

RISCV_thsurd = _ida_allins.RISCV_thsurd

RISCV_thldd = _ida_allins.RISCV_thldd

RISCV_thlwd = _ida_allins.RISCV_thlwd

RISCV_thlwud = _ida_allins.RISCV_thlwud

RISCV_thsdd = _ida_allins.RISCV_thsdd

RISCV_thswd = _ida_allins.RISCV_thswd

RISCV_thflrd = _ida_allins.RISCV_thflrd

RISCV_thflrw = _ida_allins.RISCV_thflrw

RISCV_thflurd = _ida_allins.RISCV_thflurd

RISCV_thflurw = _ida_allins.RISCV_thflurw

RISCV_thfsrd = _ida_allins.RISCV_thfsrd

RISCV_thfsrw = _ida_allins.RISCV_thfsrw

RISCV_thfsurd = _ida_allins.RISCV_thfsurd

RISCV_thfsurw = _ida_allins.RISCV_thfsurw

RISCV_thmula = _ida_allins.RISCV_thmula

RISCV_thmulah = _ida_allins.RISCV_thmulah

RISCV_thmulaw = _ida_allins.RISCV_thmulaw

RISCV_thmuls = _ida_allins.RISCV_thmuls

RISCV_thmulsh = _ida_allins.RISCV_thmulsh

RISCV_thmulsw = _ida_allins.RISCV_thmulsw

RISCV_thfmv = _ida_allins.RISCV_thfmv

RISCV_thipush = _ida_allins.RISCV_thipush

RISCV_thipop = _ida_allins.RISCV_thipop

RISCV_thandn = _ida_allins.RISCV_thandn

RISCV_thorn = _ida_allins.RISCV_thorn

RISCV_thxorn = _ida_allins.RISCV_thxorn

RISCV_thpackl = _ida_allins.RISCV_thpackl

RISCV_thpackh = _ida_allins.RISCV_thpackh

RISCV_thpackhl = _ida_allins.RISCV_thpackhl

RISCV_thvmaqa = _ida_allins.RISCV_thvmaqa

RISCV_thvmaqau = _ida_allins.RISCV_thvmaqau

RISCV_thvmaqasu = _ida_allins.RISCV_thvmaqasu

RISCV_thvmaqaus = _ida_allins.RISCV_thvmaqaus

RISCV_thvpmaqa = _ida_allins.RISCV_thvpmaqa

RISCV_thvpmaqau = _ida_allins.RISCV_thvpmaqau

RISCV_thvpmaqaus = _ida_allins.RISCV_thvpmaqaus

RISCV_thvpmaqasu = _ida_allins.RISCV_thvpmaqasu

RISCV_thvpnclip = _ida_allins.RISCV_thvpnclip

RISCV_thvpnclipu = _ida_allins.RISCV_thvpnclipu

RISCV_thvpwadd = _ida_allins.RISCV_thvpwadd

RISCV_thvpwaddu = _ida_allins.RISCV_thvpwaddu
...
XTENSA_ill = _ida_allins.XTENSA_ill

XTENSA_andi = _ida_allins.XTENSA_andi

XTENSA_ori = _ida_allins.XTENSA_ori

XTENSA_rur = _ida_allins.XTENSA_rur

XTENSA_wur = _ida_allins.XTENSA_wur

XTENSA_fsync = _ida_allins.XTENSA_fsync

XTENSA_rer = _ida_allins.XTENSA_rer

XTENSA_s32nb = _ida_allins.XTENSA_s32nb

XTENSA_salt = _ida_allins.XTENSA_salt

XTENSA_saltu = _ida_allins.XTENSA_saltu

XTENSA_wer = _ida_allins.XTENSA_wer

XTENSA_dhi_b = _ida_allins.XTENSA_dhi_b

XTENSA_dhwb_b = _ida_allins.XTENSA_dhwb_b

XTENSA_dhwbi_b = _ida_allins.XTENSA_dhwbi_b

XTENSA_dpfm_b = _ida_allins.XTENSA_dpfm_b

XTENSA_dpfm_bf = _ida_allins.XTENSA_dpfm_bf

XTENSA_dpfr_b = _ida_allins.XTENSA_dpfr_b

XTENSA_dpfr_bf = _ida_allins.XTENSA_dpfr_bf

XTENSA_dpfw_b = _ida_allins.XTENSA_dpfw_b

XTENSA_dpfw_bf = _ida_allins.XTENSA_dpfw_bf

XTENSA_all4 = _ida_allins.XTENSA_all4

XTENSA_all8 = _ida_allins.XTENSA_all8

XTENSA_andb = _ida_allins.XTENSA_andb

XTENSA_andbc = _ida_allins.XTENSA_andbc

XTENSA_any4 = _ida_allins.XTENSA_any4

XTENSA_any8 = _ida_allins.XTENSA_any8

XTENSA_bf = _ida_allins.XTENSA_bf

XTENSA_bt = _ida_allins.XTENSA_bt

XTENSA_movf = _ida_allins.XTENSA_movf

XTENSA_movt = _ida_allins.XTENSA_movt

XTENSA_orb = _ida_allins.XTENSA_orb

XTENSA_orbc = _ida_allins.XTENSA_orbc

XTENSA_xorb = _ida_allins.XTENSA_xorb

XTENSA_s32c1i = _ida_allins.XTENSA_s32c1i

XTENSA_dci = _ida_allins.XTENSA_dci

XTENSA_dcwb = _ida_allins.XTENSA_dcwb

XTENSA_dcwbi = _ida_allins.XTENSA_dcwbi

XTENSA_dhi = _ida_allins.XTENSA_dhi

XTENSA_dhu = _ida_allins.XTENSA_dhu

XTENSA_dhwb = _ida_allins.XTENSA_dhwb

XTENSA_dhwbi = _ida_allins.XTENSA_dhwbi

XTENSA_dii = _ida_allins.XTENSA_dii

XTENSA_diu = _ida_allins.XTENSA_diu

XTENSA_diwb = _ida_allins.XTENSA_diwb

XTENSA_diwbi = _ida_allins.XTENSA_diwbi

XTENSA_diwbui_p = _ida_allins.XTENSA_diwbui_p

XTENSA_dpfl = _ida_allins.XTENSA_dpfl

XTENSA_dpfr = _ida_allins.XTENSA_dpfr

XTENSA_dpfro = _ida_allins.XTENSA_dpfro

XTENSA_dpfw = _ida_allins.XTENSA_dpfw

XTENSA_dpfwo = _ida_allins.XTENSA_dpfwo

XTENSA_ldct = _ida_allins.XTENSA_ldct

XTENSA_ldcw = _ida_allins.XTENSA_ldcw

XTENSA_sdct = _ida_allins.XTENSA_sdct

XTENSA_sdcw = _ida_allins.XTENSA_sdcw

XTENSA_lddr32_p = _ida_allins.XTENSA_lddr32_p

XTENSA_rfdd = _ida_allins.XTENSA_rfdd

XTENSA_rfdo = _ida_allins.XTENSA_rfdo

XTENSA_sddr32_p = _ida_allins.XTENSA_sddr32_p

XTENSA_depbits = _ida_allins.XTENSA_depbits

XTENSA_rfde = _ida_allins.XTENSA_rfde

XTENSA_rfue = _ida_allins.XTENSA_rfue

XTENSA_syscall = _ida_allins.XTENSA_syscall

XTENSA_clrex = _ida_allins.XTENSA_clrex

XTENSA_getex = _ida_allins.XTENSA_getex

XTENSA_l32ex = _ida_allins.XTENSA_l32ex

XTENSA_s32ex = _ida_allins.XTENSA_s32ex

XTENSA_abs_d = _ida_allins.XTENSA_abs_d

XTENSA_abs_s = _ida_allins.XTENSA_abs_s

XTENSA_add_d = _ida_allins.XTENSA_add_d

XTENSA_add_s = _ida_allins.XTENSA_add_s

XTENSA_addexp_d = _ida_allins.XTENSA_addexp_d

XTENSA_addexp_s = _ida_allins.XTENSA_addexp_s

XTENSA_addexpm_d = _ida_allins.XTENSA_addexpm_d

XTENSA_addexpm_s = _ida_allins.XTENSA_addexpm_s

XTENSA_ceil_d = _ida_allins.XTENSA_ceil_d

XTENSA_ceil_s = _ida_allins.XTENSA_ceil_s

XTENSA_const_d = _ida_allins.XTENSA_const_d

XTENSA_const_s = _ida_allins.XTENSA_const_s

XTENSA_cvtd_s = _ida_allins.XTENSA_cvtd_s

XTENSA_cvts_d = _ida_allins.XTENSA_cvts_d

XTENSA_div0_d = _ida_allins.XTENSA_div0_d

XTENSA_div0_s = _ida_allins.XTENSA_div0_s

XTENSA_divn_d = _ida_allins.XTENSA_divn_d

XTENSA_divn_s = _ida_allins.XTENSA_divn_s

XTENSA_float_d = _ida_allins.XTENSA_float_d

XTENSA_float_s = _ida_allins.XTENSA_float_s

XTENSA_floor_d = _ida_allins.XTENSA_floor_d

XTENSA_floor_s = _ida_allins.XTENSA_floor_s

XTENSA_ldi = _ida_allins.XTENSA_ldi

XTENSA_ldip = _ida_allins.XTENSA_ldip

XTENSA_ldx = _ida_allins.XTENSA_ldx

XTENSA_ldxp = _ida_allins.XTENSA_ldxp

XTENSA_lsip = _ida_allins.XTENSA_lsip

XTENSA_lsiu = _ida_allins.XTENSA_lsiu

XTENSA_lsxp = _ida_allins.XTENSA_lsxp

XTENSA_lsxu = _ida_allins.XTENSA_lsxu

XTENSA_madd_d = _ida_allins.XTENSA_madd_d

XTENSA_madd_s = _ida_allins.XTENSA_madd_s

XTENSA_maddn_d = _ida_allins.XTENSA_maddn_d

XTENSA_maddn_s = _ida_allins.XTENSA_maddn_s

XTENSA_mkdadj_d = _ida_allins.XTENSA_mkdadj_d

XTENSA_mkdadj_s = _ida_allins.XTENSA_mkdadj_s

XTENSA_mksadj_d = _ida_allins.XTENSA_mksadj_d

XTENSA_mksadj_s = _ida_allins.XTENSA_mksadj_s

XTENSA_mov_d = _ida_allins.XTENSA_mov_d

XTENSA_mov_s = _ida_allins.XTENSA_mov_s

XTENSA_moveqz_s = _ida_allins.XTENSA_moveqz_s

XTENSA_movf_s = _ida_allins.XTENSA_movf_s

XTENSA_movgez_s = _ida_allins.XTENSA_movgez_s

XTENSA_movltz_s = _ida_allins.XTENSA_movltz_s

XTENSA_movnez_s = _ida_allins.XTENSA_movnez_s

XTENSA_movt_s = _ida_allins.XTENSA_movt_s

XTENSA_msub_d = _ida_allins.XTENSA_msub_d

XTENSA_msub_s = _ida_allins.XTENSA_msub_s

XTENSA_mul_d = _ida_allins.XTENSA_mul_d

XTENSA_mul_s = _ida_allins.XTENSA_mul_s

XTENSA_neg_d = _ida_allins.XTENSA_neg_d

XTENSA_neg_s = _ida_allins.XTENSA_neg_s

XTENSA_nexp01_d = _ida_allins.XTENSA_nexp01_d

XTENSA_nexp01_s = _ida_allins.XTENSA_nexp01_s

XTENSA_oeq_d = _ida_allins.XTENSA_oeq_d

XTENSA_oeq_s = _ida_allins.XTENSA_oeq_s

XTENSA_ole_d = _ida_allins.XTENSA_ole_d

XTENSA_ole_s = _ida_allins.XTENSA_ole_s

XTENSA_olt_d = _ida_allins.XTENSA_olt_d

XTENSA_olt_s = _ida_allins.XTENSA_olt_s

XTENSA_recip0_d = _ida_allins.XTENSA_recip0_d

XTENSA_recip0_s = _ida_allins.XTENSA_recip0_s

XTENSA_rfr = _ida_allins.XTENSA_rfr

XTENSA_rfrd = _ida_allins.XTENSA_rfrd

XTENSA_round_d = _ida_allins.XTENSA_round_d

XTENSA_round_s = _ida_allins.XTENSA_round_s

XTENSA_rsqrt0_d = _ida_allins.XTENSA_rsqrt0_d

XTENSA_rsqrt0_s = _ida_allins.XTENSA_rsqrt0_s

XTENSA_sdi = _ida_allins.XTENSA_sdi

XTENSA_sdip = _ida_allins.XTENSA_sdip

XTENSA_sdx = _ida_allins.XTENSA_sdx

XTENSA_sdxp = _ida_allins.XTENSA_sdxp

XTENSA_sqrt0_d = _ida_allins.XTENSA_sqrt0_d

XTENSA_sqrt0_s = _ida_allins.XTENSA_sqrt0_s

XTENSA_ssi = _ida_allins.XTENSA_ssi

XTENSA_ssip = _ida_allins.XTENSA_ssip

XTENSA_ssiu = _ida_allins.XTENSA_ssiu

XTENSA_ssx = _ida_allins.XTENSA_ssx

XTENSA_ssxp = _ida_allins.XTENSA_ssxp

XTENSA_ssxu = _ida_allins.XTENSA_ssxu

XTENSA_sub_d = _ida_allins.XTENSA_sub_d

XTENSA_sub_s = _ida_allins.XTENSA_sub_s

XTENSA_trunc_d = _ida_allins.XTENSA_trunc_d

XTENSA_trunc_s = _ida_allins.XTENSA_trunc_s

XTENSA_ueq_d = _ida_allins.XTENSA_ueq_d

XTENSA_ueq_s = _ida_allins.XTENSA_ueq_s

XTENSA_ufloat_d = _ida_allins.XTENSA_ufloat_d

XTENSA_ufloat_s = _ida_allins.XTENSA_ufloat_s

XTENSA_ule_d = _ida_allins.XTENSA_ule_d

XTENSA_ule_s = _ida_allins.XTENSA_ule_s

XTENSA_ult_d = _ida_allins.XTENSA_ult_d

XTENSA_ult_s = _ida_allins.XTENSA_ult_s

XTENSA_un_d = _ida_allins.XTENSA_un_d

XTENSA_un_s = _ida_allins.XTENSA_un_s

XTENSA_utrunc_d = _ida_allins.XTENSA_utrunc_d

XTENSA_utrunc_s = _ida_allins.XTENSA_utrunc_s

XTENSA_wfr = _ida_allins.XTENSA_wfr

XTENSA_wfrd = _ida_allins.XTENSA_wfrd

XTENSA_ihi = _ida_allins.XTENSA_ihi

XTENSA_ihu = _ida_allins.XTENSA_ihu

XTENSA_iii = _ida_allins.XTENSA_iii

XTENSA_iiu = _ida_allins.XTENSA_iiu

XTENSA_ipf = _ida_allins.XTENSA_ipf

XTENSA_ipfl = _ida_allins.XTENSA_ipfl

XTENSA_lict = _ida_allins.XTENSA_lict

XTENSA_licw = _ida_allins.XTENSA_licw

XTENSA_sict = _ida_allins.XTENSA_sict

XTENSA_sicw = _ida_allins.XTENSA_sicw

XTENSA_mulsh = _ida_allins.XTENSA_mulsh

XTENSA_muluh = _ida_allins.XTENSA_muluh

XTENSA_quos = _ida_allins.XTENSA_quos

XTENSA_quou = _ida_allins.XTENSA_quou

XTENSA_rems = _ida_allins.XTENSA_rems

XTENSA_remu = _ida_allins.XTENSA_remu

XTENSA_lddec = _ida_allins.XTENSA_lddec

XTENSA_ldinc = _ida_allins.XTENSA_ldinc

XTENSA_mul_aa = _ida_allins.XTENSA_mul_aa

XTENSA_mul_ad = _ida_allins.XTENSA_mul_ad

XTENSA_mul_da = _ida_allins.XTENSA_mul_da

XTENSA_mul_dd = _ida_allins.XTENSA_mul_dd

XTENSA_mula_aa = _ida_allins.XTENSA_mula_aa

XTENSA_mula_ad = _ida_allins.XTENSA_mula_ad

XTENSA_mula_da = _ida_allins.XTENSA_mula_da

XTENSA_mula_da_lddec = _ida_allins.XTENSA_mula_da_lddec

XTENSA_mula_da_ldinc = _ida_allins.XTENSA_mula_da_ldinc

XTENSA_mula_dd = _ida_allins.XTENSA_mula_dd

XTENSA_mula_dd_lddec = _ida_allins.XTENSA_mula_dd_lddec

XTENSA_mula_dd_ldinc = _ida_allins.XTENSA_mula_dd_ldinc

XTENSA_muls_aa = _ida_allins.XTENSA_muls_aa

XTENSA_muls_ad = _ida_allins.XTENSA_muls_ad

XTENSA_muls_da = _ida_allins.XTENSA_muls_da

XTENSA_muls_dd = _ida_allins.XTENSA_muls_dd

XTENSA_umul_aa = _ida_allins.XTENSA_umul_aa

XTENSA_rfme = _ida_allins.XTENSA_rfme

XTENSA_clamps = _ida_allins.XTENSA_clamps

XTENSA_l32ai = _ida_allins.XTENSA_l32ai

XTENSA_idtlb = _ida_allins.XTENSA_idtlb

XTENSA_iitlb = _ida_allins.XTENSA_iitlb

XTENSA_pdtlb = _ida_allins.XTENSA_pdtlb

XTENSA_pitlb = _ida_allins.XTENSA_pitlb

XTENSA_pptlb = _ida_allins.XTENSA_pptlb

XTENSA_rdtlb0 = _ida_allins.XTENSA_rdtlb0

XTENSA_rdtlb1 = _ida_allins.XTENSA_rdtlb1

XTENSA_ritlb0 = _ida_allins.XTENSA_ritlb0

XTENSA_ritlb1 = _ida_allins.XTENSA_ritlb1

XTENSA_rptlb0 = _ida_allins.XTENSA_rptlb0

XTENSA_rptlb1 = _ida_allins.XTENSA_rptlb1

XTENSA_wptlb = _ida_allins.XTENSA_wptlb

XTENSA_simcall = _ida_allins.XTENSA_simcall

XTENSA_l32e = _ida_allins.XTENSA_l32e

XTENSA_movsp = _ida_allins.XTENSA_movsp

XTENSA_rfwo = _ida_allins.XTENSA_rfwo

XTENSA_rfwu = _ida_allins.XTENSA_rfwu

XTENSA_rotw = _ida_allins.XTENSA_rotw

XTENSA_s32e = _ida_allins.XTENSA_s32e

XTENSA_clrb_expstate = _ida_allins.XTENSA_clrb_expstate

XTENSA_hwwdtlba = _ida_allins.XTENSA_hwwdtlba

XTENSA_hwwitlba = _ida_allins.XTENSA_hwwitlba

XTENSA_ldpte = _ida_allins.XTENSA_ldpte

XTENSA_read_impwire = _ida_allins.XTENSA_read_impwire

XTENSA_setb_expstate = _ida_allins.XTENSA_setb_expstate

XTENSA_wrmsk_expstate = _ida_allins.XTENSA_wrmsk_expstate

XTENSA_ae2_rur = _ida_allins.XTENSA_ae2_rur

XTENSA_ae2_wur = _ida_allins.XTENSA_ae2_wur

XTENSA_ae_rur = _ida_allins.XTENSA_ae_rur

XTENSA_ae_wur = _ida_allins.XTENSA_ae_wur

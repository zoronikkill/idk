...
def create_switch_xrefs(ea: "ea_t", si: "switch_info_t") -> "bool":
    r"""
...
class cases_and_targets_t(object):
    ...
    __repr__ = _swig_repr
    cases: "casevec_t" = property(_ida_xref.cases_and_targets_t_cases_get, _ida_xref.cases_and_targets_t_cases_set, doc=r"""cases""")
    targets: "eavec_t" = property(_ida_xref.cases_and_targets_t_targets_get, _ida_xref.cases_and_targets_t_targets_set, doc=r"""targets""")

    def __init__(self):
        r"""
        __init__(self) -> cases_and_targets_t
        """
        _ida_xref.cases_and_targets_t_swiginit(self, _ida_xref.new_cases_and_targets_t())
...
def calc_switch_cases(ea: "ea_t", si: "switch_info_t") -> "cases_and_targets_t *":
    r"""
...
def create_switch_table(ea: "ea_t", si: "switch_info_t") -> "bool":
    r"""
...
class xrefblk_t(object):
    ...
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    frm: "ea_t" = property(_ida_xref.xrefblk_t_frm_get, _ida_xref.xrefblk_t_frm_set, doc=r"""frm""")
    to: "ea_t" = property(_ida_xref.xrefblk_t_to_get, _ida_xref.xrefblk_t_to_set, doc=r"""to""")
    r"""
    the referenced address - filled by first_from(), next_from()
    """
    iscode: "uchar" = property(_ida_xref.xrefblk_t_iscode_get, _ida_xref.xrefblk_t_iscode_set, doc=r"""iscode""")
    r"""
    1-is code reference; 0-is data reference
    """
    type: "uchar" = property(_ida_xref.xrefblk_t_type_get, _ida_xref.xrefblk_t_type_set, doc=r"""type""")
    r"""
    type of the last returned reference (cref_t & dref_t)
    """
    user: "uchar" = property(_ida_xref.xrefblk_t_user_get, _ida_xref.xrefblk_t_user_set, doc=r"""user""")
    r"""
    1-is user defined xref, 0-defined by ida
    """

    def first_from(self, _from: "ea_t", flags: "int") -> "bool":
        r"""
    ...
    def first_to(self, _to: "ea_t", flags: "int") -> "bool":
        r"""
...
class casevec_t(object):
    ...
    def inject(self, s: "qvector< long long > *", len: "size_t") -> "void":
        r"""
        inject(self, s, len)
    ...
    def insert(self, it: "qvector< qvector< long long > >::iterator", x: "qvector< long long > const &") -> "qvector< qvector< long long > >::iterator":
        r"""
    ...
    def __setitem__(self, i: "size_t", v: "qvector< long long > const &") -> "void":
        r"""
    ...
    def append(self, x: "qvector< long long > const &") -> "void":
        r"""
        append(self, x)
